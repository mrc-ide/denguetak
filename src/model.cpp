...
public:
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    real_type disc_yll_all_vacc = yll_all_vacc * cum_disc;
    for (int i = 1; i <= shared->N_age; ++i) {
    ...
    real_type disc_yll_all_pop = yll_all_pop * cum_disc;
    for (int i = 1; i <= shared->N_age; ++i) {
      int j = 1;
...
cpp11::sexp dust_info<model>(const dust::pars_type<model>& pars) {
  ...
  dim[69] = cpp11::writable::integers({shared->dim_out_sdis_all_pop});
  dim[70] = cpp11::writable::integers({shared->dim_out_sdis_all_unvacc});
  dim[71] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc});
  dim[72] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_neg});
  dim[73] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_pos});
  dim[74] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_pri});
  dim[75] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_secp});
  dim[76] = cpp11::writable::integers({shared->dim_out_disc_sdis_all_pop});
  dim[77] = cpp11::writable::integers({shared->dim_out_disc_sdis_all_vacc});
  dim[78] = cpp11::writable::integers({shared->dim_out_yll_all_pop});
  dim[79] = cpp11::writable::integers({shared->dim_out_yll_all_unvacc});
  dim[80] = cpp11::writable::integers({shared->dim_out_yll_all_vacc});
  dim[81] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_neg});
  dim[82] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_pos});
  dim[83] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_pri});
  dim[84] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_secp});
  dim[85] = cpp11::writable::integers({shared->dim_out_disc_yll_all_pop});
  dim[86] = cpp11::writable::integers({shared->dim_out_disc_yll_all_vacc});
  dim[87] = cpp11::writable::integers({shared->dim_out_nvacc_all_pop});
  dim[88] = cpp11::writable::integers({shared->dim_out_nvacc_all_neg});
  dim[89] = cpp11::writable::integers({shared->dim_out_nvacc_all_pos});
  dim[90] = cpp11::writable::integers({shared->dim_out_disc_nvacc_all_pop});
  dim[91] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[92] = cpp11::writable::integers({shared->dim_I1_1, shared->dim_I1_2});
  dim[93] = cpp11::writable::integers({shared->dim_I2_1, shared->dim_I2_2});
  dim[94] = cpp11::writable::integers({shared->dim_I3_1, shared->dim_I3_2});
  dim[95] = cpp11::writable::integers({shared->dim_I4_1, shared->dim_I4_2});
  dim[96] = cpp11::writable::integers({shared->dim_R1_1, shared->dim_R1_2});
  dim[97] = cpp11::writable::integers({shared->dim_R2_1, shared->dim_R2_2});
  dim[98] = cpp11::writable::integers({shared->dim_R3_1, shared->dim_R3_2});
  dim[99] = cpp11::writable::integers({shared->dim_R4_1, shared->dim_R4_2});
  dim[100] = cpp11::writable::integers({shared->dim_I21_1, shared->dim_I21_2});
  dim[101] = cpp11::writable::integers({shared->dim_I31_1, shared->dim_I31_2});
  dim[102] = cpp11::writable::integers({shared->dim_I41_1, shared->dim_I41_2});
  dim[103] = cpp11::writable::integers({shared->dim_I12_1, shared->dim_I12_2});
  dim[104] = cpp11::writable::integers({shared->dim_I32_1, shared->dim_I32_2});
  dim[105] = cpp11::writable::integers({shared->dim_I42_1, shared->dim_I42_2});
  dim[106] = cpp11::writable::integers({shared->dim_I13_1, shared->dim_I13_2});
  dim[107] = cpp11::writable::integers({shared->dim_I23_1, shared->dim_I23_2});
  dim[108] = cpp11::writable::integers({shared->dim_I43_1, shared->dim_I43_2});
  dim[109] = cpp11::writable::integers({shared->dim_I14_1, shared->dim_I14_2});
  dim[110] = cpp11::writable::integers({shared->dim_I24_1, shared->dim_I24_2});
  dim[111] = cpp11::writable::integers({shared->dim_I34_1, shared->dim_I34_2});
  dim[112] = cpp11::writable::integers({shared->dim_R12_1, shared->dim_R12_2});
  dim[113] = cpp11::writable::integers({shared->dim_R13_1, shared->dim_R13_2});
  dim[114] = cpp11::writable::integers({shared->dim_R14_1, shared->dim_R14_2});
  dim[115] = cpp11::writable::integers({shared->dim_R23_1, shared->dim_R23_2});
  dim[116] = cpp11::writable::integers({shared->dim_R24_1, shared->dim_R24_2});
  dim[117] = cpp11::writable::integers({shared->dim_R34_1, shared->dim_R34_2});
  dim[118] = cpp11::writable::integers({shared->dim_I231_1, shared->dim_I231_2});
  dim[119] = cpp11::writable::integers({shared->dim_I241_1, shared->dim_I241_2});
  dim[120] = cpp11::writable::integers({shared->dim_I341_1, shared->dim_I341_2});
  dim[121] = cpp11::writable::integers({shared->dim_I132_1, shared->dim_I132_2});
  dim[122] = cpp11::writable::integers({shared->dim_I142_1, shared->dim_I142_2});
  dim[123] = cpp11::writable::integers({shared->dim_I342_1, shared->dim_I342_2});
  dim[124] = cpp11::writable::integers({shared->dim_I123_1, shared->dim_I123_2});
  dim[125] = cpp11::writable::integers({shared->dim_I143_1, shared->dim_I143_2});
  dim[126] = cpp11::writable::integers({shared->dim_I243_1, shared->dim_I243_2});
  dim[127] = cpp11::writable::integers({shared->dim_I124_1, shared->dim_I124_2});
  dim[128] = cpp11::writable::integers({shared->dim_I134_1, shared->dim_I134_2});
  dim[129] = cpp11::writable::integers({shared->dim_I234_1, shared->dim_I234_2});
  dim[130] = cpp11::writable::integers({shared->dim_R123_1, shared->dim_R123_2});
  dim[131] = cpp11::writable::integers({shared->dim_R124_1, shared->dim_R124_2});
  dim[132] = cpp11::writable::integers({shared->dim_R134_1, shared->dim_R134_2});
  dim[133] = cpp11::writable::integers({shared->dim_R234_1, shared->dim_R234_2});
  dim[134] = cpp11::writable::integers({shared->dim_I2341_1, shared->dim_I2341_2});
  dim[135] = cpp11::writable::integers({shared->dim_I1342_1, shared->dim_I1342_2});
  dim[136] = cpp11::writable::integers({shared->dim_I1243_1, shared->dim_I1243_2});
  dim[137] = cpp11::writable::integers({shared->dim_I1234_1, shared->dim_I1234_2});
  dim[138] = cpp11::writable::integers({shared->dim_R1234_1, shared->dim_R1234_2});
  dim[139] = cpp11::writable::integers({shared->dim_out_dis_sero_pop_1, shared->dim_out_dis_sero_pop_2});
  dim[140] = cpp11::writable::integers({shared->dim_out_dis_sero_unvacc_1, shared->dim_out_dis_sero_unvacc_2});
  dim[141] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_1, shared->dim_out_dis_sero_vacc_2});
  dim[142] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_neg_1, shared->dim_out_dis_sero_vacc_neg_2});
  dim[143] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_pos_1, shared->dim_out_dis_sero_vacc_pos_2});
  dim[144] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_pri_1, shared->dim_out_dis_sero_vacc_pri_2});
  dim[145] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_secp_1, shared->dim_out_dis_sero_vacc_secp_2});
  dim[146] = cpp11::writable::integers({shared->dim_out_sdis_sero_pop_1, shared->dim_out_sdis_sero_pop_2});
  dim[147] = cpp11::writable::integers({shared->dim_out_sdis_sero_unvacc_1, shared->dim_out_sdis_sero_unvacc_2});
  dim[148] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_1, shared->dim_out_sdis_sero_vacc_2});
  dim[149] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_neg_1, shared->dim_out_sdis_sero_vacc_neg_2});
  dim[150] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_pos_1, shared->dim_out_sdis_sero_vacc_pos_2});
  dim[151] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_pri_1, shared->dim_out_sdis_sero_vacc_pri_2});
  dim[152] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_secp_1, shared->dim_out_sdis_sero_vacc_secp_2});
  dim[153] = cpp11::writable::integers({shared->dim_out_yll_sero_pop_1, shared->dim_out_yll_sero_pop_2});
  dim[154] = cpp11::writable::integers({shared->dim_out_yll_sero_unvacc_1, shared->dim_out_yll_sero_unvacc_2});
  dim[155] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_1, shared->dim_out_yll_sero_vacc_2});
  dim[156] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_neg_1, shared->dim_out_yll_sero_vacc_neg_2});
  dim[157] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_pos_1, shared->dim_out_yll_sero_vacc_pos_2});
  dim[158] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_pri_1, shared->dim_out_yll_sero_vacc_pri_2});
  dim[159] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_secp_1, shared->dim_out_yll_sero_vacc_secp_2});
  dim[160] = cpp11::writable::integers({shared->dim_out_nc_1, shared->dim_out_nc_2, shared->dim_out_nc_3});
  dim[161] = cpp11::writable::integers({shared->dim_out_RR_1, shared->dim_out_RR_2, shared->dim_out_RR_3});
  dim.names() = nms;
  cpp11::writable::list index(162);
  ...
  index[69] = integer_sequence(shared->offset_variable_out_sdis_all_pop + 1, shared->dim_out_sdis_all_pop);
  index[70] = integer_sequence(shared->offset_variable_out_sdis_all_unvacc + 1, shared->dim_out_sdis_all_unvacc);
  index[71] = integer_sequence(shared->offset_variable_out_sdis_all_vacc + 1, shared->dim_out_sdis_all_vacc);
  index[72] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_neg + 1, shared->dim_out_sdis_all_vacc_neg);
  index[73] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_pos + 1, shared->dim_out_sdis_all_vacc_pos);
  index[74] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_pri + 1, shared->dim_out_sdis_all_vacc_pri);
  index[75] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_secp + 1, shared->dim_out_sdis_all_vacc_secp);
  index[76] = integer_sequence(shared->offset_variable_out_disc_sdis_all_pop + 1, shared->dim_out_disc_sdis_all_pop);
  index[77] = integer_sequence(shared->offset_variable_out_disc_sdis_all_vacc + 1, shared->dim_out_disc_sdis_all_vacc);
  index[78] = integer_sequence(shared->offset_variable_out_yll_all_pop + 1, shared->dim_out_yll_all_pop);
  index[79] = integer_sequence(shared->offset_variable_out_yll_all_unvacc + 1, shared->dim_out_yll_all_unvacc);
  index[80] = integer_sequence(shared->offset_variable_out_yll_all_vacc + 1, shared->dim_out_yll_all_vacc);
  index[81] = integer_sequence(shared->offset_variable_out_yll_all_vacc_neg + 1, shared->dim_out_yll_all_vacc_neg);
  index[82] = integer_sequence(shared->offset_variable_out_yll_all_vacc_pos + 1, shared->dim_out_yll_all_vacc_pos);
  index[83] = integer_sequence(shared->offset_variable_out_yll_all_vacc_pri + 1, shared->dim_out_yll_all_vacc_pri);
  index[84] = integer_sequence(shared->offset_variable_out_yll_all_vacc_secp + 1, shared->dim_out_yll_all_vacc_secp);
  index[85] = integer_sequence(shared->offset_variable_out_disc_yll_all_pop + 1, shared->dim_out_disc_yll_all_pop);
  index[86] = integer_sequence(shared->offset_variable_out_disc_yll_all_vacc + 1, shared->dim_out_disc_yll_all_vacc);
  index[87] = integer_sequence(shared->offset_variable_out_nvacc_all_pop + 1, shared->dim_out_nvacc_all_pop);
  index[88] = integer_sequence(shared->offset_variable_out_nvacc_all_neg + 1, shared->dim_out_nvacc_all_neg);
  index[89] = integer_sequence(shared->offset_variable_out_nvacc_all_pos + 1, shared->dim_out_nvacc_all_pos);
  index[90] = integer_sequence(shared->offset_variable_out_disc_nvacc_all_pop + 1, shared->dim_out_disc_nvacc_all_pop);
  index[91] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  index[92] = integer_sequence(shared->offset_variable_I1 + 1, shared->dim_I1);
  index[93] = integer_sequence(shared->offset_variable_I2 + 1, shared->dim_I2);
  index[94] = integer_sequence(shared->offset_variable_I3 + 1, shared->dim_I3);
  index[95] = integer_sequence(shared->offset_variable_I4 + 1, shared->dim_I4);
  index[96] = integer_sequence(shared->offset_variable_R1 + 1, shared->dim_R1);
  index[97] = integer_sequence(shared->offset_variable_R2 + 1, shared->dim_R2);
  index[98] = integer_sequence(shared->offset_variable_R3 + 1, shared->dim_R3);
  index[99] = integer_sequence(shared->offset_variable_R4 + 1, shared->dim_R4);
  index[100] = integer_sequence(shared->offset_variable_I21 + 1, shared->dim_I21);
  index[101] = integer_sequence(shared->offset_variable_I31 + 1, shared->dim_I31);
  index[102] = integer_sequence(shared->offset_variable_I41 + 1, shared->dim_I41);
  index[103] = integer_sequence(shared->offset_variable_I12 + 1, shared->dim_I12);
  index[104] = integer_sequence(shared->offset_variable_I32 + 1, shared->dim_I32);
  index[105] = integer_sequence(shared->offset_variable_I42 + 1, shared->dim_I42);
  index[106] = integer_sequence(shared->offset_variable_I13 + 1, shared->dim_I13);
  index[107] = integer_sequence(shared->offset_variable_I23 + 1, shared->dim_I23);
  index[108] = integer_sequence(shared->offset_variable_I43 + 1, shared->dim_I43);
  index[109] = integer_sequence(shared->offset_variable_I14 + 1, shared->dim_I14);
  index[110] = integer_sequence(shared->offset_variable_I24 + 1, shared->dim_I24);
  index[111] = integer_sequence(shared->offset_variable_I34 + 1, shared->dim_I34);
  index[112] = integer_sequence(shared->offset_variable_R12 + 1, shared->dim_R12);
  index[113] = integer_sequence(shared->offset_variable_R13 + 1, shared->dim_R13);
  index[114] = integer_sequence(shared->offset_variable_R14 + 1, shared->dim_R14);
  index[115] = integer_sequence(shared->offset_variable_R23 + 1, shared->dim_R23);
  index[116] = integer_sequence(shared->offset_variable_R24 + 1, shared->dim_R24);
  index[117] = integer_sequence(shared->offset_variable_R34 + 1, shared->dim_R34);
  index[118] = integer_sequence(shared->offset_variable_I231 + 1, shared->dim_I231);
  index[119] = integer_sequence(shared->offset_variable_I241 + 1, shared->dim_I241);
  index[120] = integer_sequence(shared->offset_variable_I341 + 1, shared->dim_I341);
  index[121] = integer_sequence(shared->offset_variable_I132 + 1, shared->dim_I132);
  index[122] = integer_sequence(shared->offset_variable_I142 + 1, shared->dim_I142);
  index[123] = integer_sequence(shared->offset_variable_I342 + 1, shared->dim_I342);
  index[124] = integer_sequence(shared->offset_variable_I123 + 1, shared->dim_I123);
  index[125] = integer_sequence(shared->offset_variable_I143 + 1, shared->dim_I143);
  index[126] = integer_sequence(shared->offset_variable_I243 + 1, shared->dim_I243);
  index[127] = integer_sequence(shared->offset_variable_I124 + 1, shared->dim_I124);
  index[128] = integer_sequence(shared->offset_variable_I134 + 1, shared->dim_I134);
  index[129] = integer_sequence(shared->offset_variable_I234 + 1, shared->dim_I234);
  index[130] = integer_sequence(shared->offset_variable_R123 + 1, shared->dim_R123);
  index[131] = integer_sequence(shared->offset_variable_R124 + 1, shared->dim_R124);
  index[132] = integer_sequence(shared->offset_variable_R134 + 1, shared->dim_R134);
  index[133] = integer_sequence(shared->offset_variable_R234 + 1, shared->dim_R234);
  index[134] = integer_sequence(shared->offset_variable_I2341 + 1, shared->dim_I2341);
  index[135] = integer_sequence(shared->offset_variable_I1342 + 1, shared->dim_I1342);
  index[136] = integer_sequence(shared->offset_variable_I1243 + 1, shared->dim_I1243);
  index[137] = integer_sequence(shared->offset_variable_I1234 + 1, shared->dim_I1234);
  index[138] = integer_sequence(shared->offset_variable_R1234 + 1, shared->dim_R1234);
  index[139] = integer_sequence(shared->offset_variable_out_dis_sero_pop + 1, shared->dim_out_dis_sero_pop);
  index[140] = integer_sequence(shared->offset_variable_out_dis_sero_unvacc + 1, shared->dim_out_dis_sero_unvacc);
  index[141] = integer_sequence(shared->offset_variable_out_dis_sero_vacc + 1, shared->dim_out_dis_sero_vacc);
  index[142] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_neg + 1, shared->dim_out_dis_sero_vacc_neg);
  index[143] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_pos + 1, shared->dim_out_dis_sero_vacc_pos);
  index[144] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_pri + 1, shared->dim_out_dis_sero_vacc_pri);
  index[145] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_secp + 1, shared->dim_out_dis_sero_vacc_secp);
  index[146] = integer_sequence(shared->offset_variable_out_sdis_sero_pop + 1, shared->dim_out_sdis_sero_pop);
  index[147] = integer_sequence(shared->offset_variable_out_sdis_sero_unvacc + 1, shared->dim_out_sdis_sero_unvacc);
  index[148] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc + 1, shared->dim_out_sdis_sero_vacc);
  index[149] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_neg + 1, shared->dim_out_sdis_sero_vacc_neg);
  index[150] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_pos + 1, shared->dim_out_sdis_sero_vacc_pos);
  index[151] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_pri + 1, shared->dim_out_sdis_sero_vacc_pri);
  index[152] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_secp + 1, shared->dim_out_sdis_sero_vacc_secp);
  index[153] = integer_sequence(shared->offset_variable_out_yll_sero_pop + 1, shared->dim_out_yll_sero_pop);
  index[154] = integer_sequence(shared->offset_variable_out_yll_sero_unvacc + 1, shared->dim_out_yll_sero_unvacc);
  index[155] = integer_sequence(shared->offset_variable_out_yll_sero_vacc + 1, shared->dim_out_yll_sero_vacc);
  index[156] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_neg + 1, shared->dim_out_yll_sero_vacc_neg);
  index[157] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_pos + 1, shared->dim_out_yll_sero_vacc_pos);
  index[158] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_pri + 1, shared->dim_out_yll_sero_vacc_pri);
  index[159] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_secp + 1, shared->dim_out_yll_sero_vacc_secp);
  index[160] = integer_sequence(shared->offset_variable_out_nc + 1, shared->dim_out_nc);
  index[161] = integer_sequence(shared->offset_variable_out_RR + 1, shared->dim_out_RR);
  index.names() = nms;
