...
// [[dust::param(nc50_inf, has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE)]]
...
public:
  ...
  struct shared_type {
    ...
    int dim_births_d_1;
    int dim_births_d_2;
    int dim_cohort_dis_sero_unvacc;
    int dim_cohort_dis_sero_vacc;
    int dim_cohort_dis_sero_vacc_neg;
    int dim_cohort_dis_sero_vacc_pos;
    int dim_cohort_dis_sero_vacc_pri;
    int dim_cohort_dis_sero_vacc_secp;
    int dim_cohort_sdis_sero_unvacc;
    int dim_cohort_sdis_sero_vacc;
    int dim_cohort_sdis_sero_vacc_neg;
    int dim_cohort_sdis_sero_vacc_pos;
    int dim_cohort_sdis_sero_vacc_pri;
    int dim_cohort_sdis_sero_vacc_secp;
    int dim_coverage_d;
    ...
    int dim_O_S_1;
    int dim_O_S_2;
    int dim_out_cohort_dis_sero_unvacc;
    int dim_out_cohort_dis_sero_unvacc_1;
    int dim_out_cohort_dis_sero_unvacc_2;
    int dim_out_cohort_dis_sero_vacc;
    int dim_out_cohort_dis_sero_vacc_1;
    int dim_out_cohort_dis_sero_vacc_2;
    int dim_out_cohort_dis_sero_vacc_neg;
    int dim_out_cohort_dis_sero_vacc_neg_1;
    int dim_out_cohort_dis_sero_vacc_neg_2;
    int dim_out_cohort_dis_sero_vacc_pos;
    int dim_out_cohort_dis_sero_vacc_pos_1;
    int dim_out_cohort_dis_sero_vacc_pos_2;
    int dim_out_cohort_dis_sero_vacc_pri;
    int dim_out_cohort_dis_sero_vacc_pri_1;
    int dim_out_cohort_dis_sero_vacc_pri_2;
    int dim_out_cohort_dis_sero_vacc_secp;
    int dim_out_cohort_dis_sero_vacc_secp_1;
    int dim_out_cohort_dis_sero_vacc_secp_2;
    int dim_out_cohort_nvacc_neg;
    int dim_out_cohort_nvacc_pos;
    int dim_out_cohort_sdis_sero_unvacc;
    int dim_out_cohort_sdis_sero_unvacc_1;
    int dim_out_cohort_sdis_sero_unvacc_2;
    int dim_out_cohort_sdis_sero_vacc;
    int dim_out_cohort_sdis_sero_vacc_1;
    int dim_out_cohort_sdis_sero_vacc_2;
    int dim_out_cohort_sdis_sero_vacc_neg;
    int dim_out_cohort_sdis_sero_vacc_neg_1;
    int dim_out_cohort_sdis_sero_vacc_neg_2;
    int dim_out_cohort_sdis_sero_vacc_pos;
    int dim_out_cohort_sdis_sero_vacc_pos_1;
    int dim_out_cohort_sdis_sero_vacc_pos_2;
    int dim_out_cohort_sdis_sero_vacc_pri;
    int dim_out_cohort_sdis_sero_vacc_pri_1;
    int dim_out_cohort_sdis_sero_vacc_pri_2;
    int dim_out_cohort_sdis_sero_vacc_secp;
    int dim_out_cohort_sdis_sero_vacc_secp_1;
    int dim_out_cohort_sdis_sero_vacc_secp_2;
    ...
    int dim_out_dis_all_vacc_pri;
    int dim_out_dis_all_vacc_secp;
    ...
    int dim_out_sdis_all_vacc_pri;
    int dim_out_sdis_all_vacc_secp;
    ...
    int dim_out_yll_all_vacc_pri;
    int dim_out_yll_all_vacc_secp;
    ...
    std::vector<real_type> initial_out_cohort_dis_sero_unvacc;
    std::vector<real_type> initial_out_cohort_dis_sero_vacc;
    std::vector<real_type> initial_out_cohort_dis_sero_vacc_neg;
    std::vector<real_type> initial_out_cohort_dis_sero_vacc_pos;
    std::vector<real_type> initial_out_cohort_dis_sero_vacc_pri;
    std::vector<real_type> initial_out_cohort_dis_sero_vacc_secp;
    std::vector<real_type> initial_out_cohort_nvacc_neg;
    std::vector<real_type> initial_out_cohort_nvacc_pos;
    std::vector<real_type> initial_out_cohort_sdis_sero_unvacc;
    std::vector<real_type> initial_out_cohort_sdis_sero_vacc;
    std::vector<real_type> initial_out_cohort_sdis_sero_vacc_neg;
    std::vector<real_type> initial_out_cohort_sdis_sero_vacc_pos;
    std::vector<real_type> initial_out_cohort_sdis_sero_vacc_pri;
    std::vector<real_type> initial_out_cohort_sdis_sero_vacc_secp;
    ...
    std::vector<real_type> initial_out_dis_all_vacc_pri;
    std::vector<real_type> initial_out_dis_all_vacc_secp;
    ...
    std::vector<real_type> initial_out_sdis_all_vacc_pri;
    std::vector<real_type> initial_out_sdis_all_vacc_secp;
    ...
    std::vector<real_type> initial_out_yll_all_vacc_pri;
    std::vector<real_type> initial_out_yll_all_vacc_secp;
    ...
    int offset_variable_out_cohort_dis_sero_unvacc;
    int offset_variable_out_cohort_dis_sero_vacc;
    int offset_variable_out_cohort_dis_sero_vacc_neg;
    int offset_variable_out_cohort_dis_sero_vacc_pos;
    int offset_variable_out_cohort_dis_sero_vacc_pri;
    int offset_variable_out_cohort_dis_sero_vacc_secp;
    int offset_variable_out_cohort_nvacc_neg;
    int offset_variable_out_cohort_nvacc_pos;
    int offset_variable_out_cohort_sdis_sero_unvacc;
    int offset_variable_out_cohort_sdis_sero_vacc;
    int offset_variable_out_cohort_sdis_sero_vacc_neg;
    int offset_variable_out_cohort_sdis_sero_vacc_pos;
    int offset_variable_out_cohort_sdis_sero_vacc_pri;
    int offset_variable_out_cohort_sdis_sero_vacc_secp;
    ...
    int offset_variable_out_dis_all_vacc_pri;
    int offset_variable_out_dis_all_vacc_secp;
    ...
    int offset_variable_out_sdis_all_vacc_pri;
    int offset_variable_out_sdis_all_vacc_secp;
    ...
    int offset_variable_out_yll_all_vacc_pri;
    int offset_variable_out_yll_all_vacc_secp;
  ...
  struct internal_type {
    ...
    std::vector<real_type> cohort_dis_sero_unvacc;
    std::vector<real_type> cohort_dis_sero_vacc;
    std::vector<real_type> cohort_dis_sero_vacc_neg;
    std::vector<real_type> cohort_dis_sero_vacc_pos;
    std::vector<real_type> cohort_dis_sero_vacc_pri;
    std::vector<real_type> cohort_dis_sero_vacc_secp;
    std::vector<real_type> cohort_sdis_sero_unvacc;
    std::vector<real_type> cohort_sdis_sero_vacc;
    std::vector<real_type> cohort_sdis_sero_vacc_neg;
    std::vector<real_type> cohort_sdis_sero_vacc_pos;
    std::vector<real_type> cohort_sdis_sero_vacc_pri;
    std::vector<real_type> cohort_sdis_sero_vacc_secp;
  ...
  size_t size() const {
    return shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_RR + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_out_yll_sero_pop + shared->dim_out_yll_sero_unvacc + shared->dim_out_yll_sero_vacc + shared->dim_out_yll_sero_vacc_neg + shared->dim_out_yll_sero_vacc_pos + shared->dim_out_yll_sero_vacc_pri + shared->dim_out_yll_sero_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  }
  std::vector<real_type> initial(size_t step, rng_state_type& rng_state) {
    ...
    std::copy(shared->initial_out_dis_all_vacc_pri.begin(), shared->initial_out_dis_all_vacc_pri.end(), state.begin() + shared->offset_variable_out_dis_all_vacc_pri);
    std::copy(shared->initial_out_dis_all_vacc_secp.begin(), shared->initial_out_dis_all_vacc_secp.end(), state.begin() + shared->offset_variable_out_dis_all_vacc_secp);
    ...
    std::copy(shared->initial_out_cohort_nvacc_neg.begin(), shared->initial_out_cohort_nvacc_neg.end(), state.begin() + shared->offset_variable_out_cohort_nvacc_neg);
    std::copy(shared->initial_out_cohort_nvacc_pos.begin(), shared->initial_out_cohort_nvacc_pos.end(), state.begin() + shared->offset_variable_out_cohort_nvacc_pos);
    ...
    std::copy(shared->initial_out_sdis_all_vacc_pri.begin(), shared->initial_out_sdis_all_vacc_pri.end(), state.begin() + shared->offset_variable_out_sdis_all_vacc_pri);
    std::copy(shared->initial_out_sdis_all_vacc_secp.begin(), shared->initial_out_sdis_all_vacc_secp.end(), state.begin() + shared->offset_variable_out_sdis_all_vacc_secp);
    ...
    std::copy(shared->initial_out_yll_all_vacc_pri.begin(), shared->initial_out_yll_all_vacc_pri.end(), state.begin() + shared->offset_variable_out_yll_all_vacc_pri);
    std::copy(shared->initial_out_yll_all_vacc_secp.begin(), shared->initial_out_yll_all_vacc_secp.end(), state.begin() + shared->offset_variable_out_yll_all_vacc_secp);
    ...
    std::copy(shared->initial_out_cohort_dis_sero_unvacc.begin(), shared->initial_out_cohort_dis_sero_unvacc.end(), state.begin() + shared->offset_variable_out_cohort_dis_sero_unvacc);
    std::copy(shared->initial_out_cohort_dis_sero_vacc.begin(), shared->initial_out_cohort_dis_sero_vacc.end(), state.begin() + shared->offset_variable_out_cohort_dis_sero_vacc);
    std::copy(shared->initial_out_cohort_dis_sero_vacc_pri.begin(), shared->initial_out_cohort_dis_sero_vacc_pri.end(), state.begin() + shared->offset_variable_out_cohort_dis_sero_vacc_pri);
    std::copy(shared->initial_out_cohort_dis_sero_vacc_secp.begin(), shared->initial_out_cohort_dis_sero_vacc_secp.end(), state.begin() + shared->offset_variable_out_cohort_dis_sero_vacc_secp);
    std::copy(shared->initial_out_cohort_dis_sero_vacc_neg.begin(), shared->initial_out_cohort_dis_sero_vacc_neg.end(), state.begin() + shared->offset_variable_out_cohort_dis_sero_vacc_neg);
    std::copy(shared->initial_out_cohort_dis_sero_vacc_pos.begin(), shared->initial_out_cohort_dis_sero_vacc_pos.end(), state.begin() + shared->offset_variable_out_cohort_dis_sero_vacc_pos);
    ...
    std::copy(shared->initial_out_cohort_sdis_sero_unvacc.begin(), shared->initial_out_cohort_sdis_sero_unvacc.end(), state.begin() + shared->offset_variable_out_cohort_sdis_sero_unvacc);
    std::copy(shared->initial_out_cohort_sdis_sero_vacc.begin(), shared->initial_out_cohort_sdis_sero_vacc.end(), state.begin() + shared->offset_variable_out_cohort_sdis_sero_vacc);
    std::copy(shared->initial_out_cohort_sdis_sero_vacc_pri.begin(), shared->initial_out_cohort_sdis_sero_vacc_pri.end(), state.begin() + shared->offset_variable_out_cohort_sdis_sero_vacc_pri);
    std::copy(shared->initial_out_cohort_sdis_sero_vacc_secp.begin(), shared->initial_out_cohort_sdis_sero_vacc_secp.end(), state.begin() + shared->offset_variable_out_cohort_sdis_sero_vacc_secp);
    std::copy(shared->initial_out_cohort_sdis_sero_vacc_neg.begin(), shared->initial_out_cohort_sdis_sero_vacc_neg.end(), state.begin() + shared->offset_variable_out_cohort_sdis_sero_vacc_neg);
    std::copy(shared->initial_out_cohort_sdis_sero_vacc_pos.begin(), shared->initial_out_cohort_sdis_sero_vacc_pos.end(), state.begin() + shared->offset_variable_out_cohort_sdis_sero_vacc_pos);
  ...
  void update(size_t step, const real_type * state, rng_state_type& rng_state, real_type * state_next) {
    ...
    const real_type * out_dis_all_vacc_pri = state + shared->offset_variable_out_dis_all_vacc_pri;
    const real_type * out_dis_all_vacc_secp = state + shared->offset_variable_out_dis_all_vacc_secp;
    ...
    const real_type * out_cohort_nvacc_neg = state + shared->offset_variable_out_cohort_nvacc_neg;
    const real_type * out_cohort_nvacc_pos = state + shared->offset_variable_out_cohort_nvacc_pos;
    const real_type * out_cohort_dis_sero_unvacc = state + shared->offset_variable_out_cohort_dis_sero_unvacc;
    const real_type * out_cohort_dis_sero_vacc = state + shared->offset_variable_out_cohort_dis_sero_vacc;
    const real_type * out_cohort_dis_sero_vacc_pri = state + shared->offset_variable_out_cohort_dis_sero_vacc_pri;
    const real_type * out_cohort_dis_sero_vacc_secp = state + shared->offset_variable_out_cohort_dis_sero_vacc_secp;
    const real_type * out_cohort_dis_sero_vacc_neg = state + shared->offset_variable_out_cohort_dis_sero_vacc_neg;
    const real_type * out_cohort_dis_sero_vacc_pos = state + shared->offset_variable_out_cohort_dis_sero_vacc_pos;
    ...
    const real_type * out_sdis_all_vacc_pri = state + shared->offset_variable_out_sdis_all_vacc_pri;
    const real_type * out_sdis_all_vacc_secp = state + shared->offset_variable_out_sdis_all_vacc_secp;
    ...
    const real_type * out_cohort_sdis_sero_unvacc = state + shared->offset_variable_out_cohort_sdis_sero_unvacc;
    const real_type * out_cohort_sdis_sero_vacc = state + shared->offset_variable_out_cohort_sdis_sero_vacc;
    const real_type * out_cohort_sdis_sero_vacc_pri = state + shared->offset_variable_out_cohort_sdis_sero_vacc_pri;
    const real_type * out_cohort_sdis_sero_vacc_secp = state + shared->offset_variable_out_cohort_sdis_sero_vacc_secp;
    const real_type * out_cohort_sdis_sero_vacc_neg = state + shared->offset_variable_out_cohort_sdis_sero_vacc_neg;
    const real_type * out_cohort_sdis_sero_vacc_pos = state + shared->offset_variable_out_cohort_sdis_sero_vacc_pos;
    ...
    const real_type * out_yll_all_vacc_pri = state + shared->offset_variable_out_yll_all_vacc_pri;
    const real_type * out_yll_all_vacc_secp = state + shared->offset_variable_out_yll_all_vacc_secp;
    ...
    real_type cum_disc = (YEARS_POST_VACC < 0 ? 0 : 1 / (real_type) (dust::math::pow<real_type>(shared->disc_fact, YEARS_POST_VACC)));
    real_type cum_disc_vacc = (YEARS_POST_VACC < 0 ? 0 : 1 / (real_type) (dust::math::pow<real_type>(shared->disc_fact_vacc, YEARS_POST_VACC)));
    real_type intYPV = dust::math::floor(YEARS_POST_VACC) + 1;
    for (int i = 1; i <= shared->N_age; ++i) {
      for (int j = 1; j <= 3; ++j) {
    ...
    real_type cohort_nvacc_neg = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.Ntotal[shared->dim_Ntotal_1 * 2 + static_cast<int>(intYPV + shared->vca) - 1]);
    real_type cohort_nvacc_pos = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.Ntotal[shared->dim_Ntotal_1 * 1 + static_cast<int>(intYPV + shared->vca) - 1]);
    ...
    real_type L_deathrt = shared->DT * shared->sigma * ((1 + dust::math::pow<real_type>(((Lwt + Lwb) / (real_type) (Kc * NT)), shared->omega)));
    for (int i = 1; i <= 4; ++i) {
      for (int j = 1; j <= 3; ++j) {
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_cohort_nvacc_neg + i - 1] = (internal.out_update_switch[i - 1] == 0 ? out_cohort_nvacc_neg[i - 1] : cohort_nvacc_neg);
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_cohort_nvacc_pos + i - 1] = (internal.out_update_switch[i - 1] == 0 ? out_cohort_nvacc_pos[i - 1] : cohort_nvacc_pos);
    }
    ...
    for (int i = 1; i <= 4; ++i) {
      ...
      for (int k = 1; k <= shared->N_age; ++k) {
        internal.RR_inf_cu[i - 1 + shared->dim_RR_inf_cu_1 * (j - 1) + shared->dim_RR_inf_cu_12 * (k - 1)] = ((shared->ZeroVE == 0) && (shared->DoVEInf) && (shared->ageb[k - 1] >= youngest_cu_age) && (shared->ageb[k - 1] <= oldest_cu_age) ? 1 / (real_type) (1 + dust::math::pow<real_type>((internal.nc_cu[shared->dim_nc_cu_1 * (j - 1) + i - 1] / (real_type) (shared->nc50_inf[shared->dim_nc50_inf_1 * (j - 1) + i - 1] * shared->nc50_age[k - 1])), shared->ws[i - 1])) : 1);
      }
    }
    for (int i = 1; i <= 4; ++i) {
      for (int j = 2; j <= 3; ++j) {
    ...
    for (int i = 1; i <= 4; ++i) {
      for (int j = 1; j <= 3; ++j) {
        for (int k = 1; k <= shared->N_age; ++k) {
          internal.RR_sdis_cu[i - 1 + shared->dim_RR_sdis_cu_1 * (j - 1) + shared->dim_RR_sdis_cu_12 * (k - 1)] = ((shared->ZeroVE == 1) || (shared->ageb[k - 1] < youngest_cu_age) || (shared->ageb[k - 1] > oldest_cu_age) ? 1 : shared->L_sdis[shared->dim_L_sdis_1 * (j - 1) + i - 1] / (real_type) (1 + dust::math::pow<real_type>((internal.nc_cu[shared->dim_nc_cu_1 * (j - 1) + i - 1] / (real_type) (shared->nc50_sdis[shared->dim_nc50_sdis_1 * (j - 1) + i - 1] * shared->nc50_age[k - 1])), shared->ws[i - 1])) / (real_type) internal.RR_inf_cu[shared->dim_RR_inf_cu_12 * (k - 1) + shared->dim_RR_inf_cu_1 * (j - 1) + i - 1]);
        }
      }
    }
    ...
    for (int i = 1; i <= 4; ++i) {
      int j = 1;
      for (int k = 1; k <= shared->N_age; ++k) {
        internal.RR_inf_vc[i - 1 + shared->dim_RR_inf_vc_1 * (j - 1) + shared->dim_RR_inf_vc_12 * (k - 1)] = ((shared->ZeroVE == 0) && (shared->DoVEInf) ? 1 / (real_type) (1 + dust::math::pow<real_type>((internal.nc[shared->dim_nc_12 * (k - 1) + shared->dim_nc_1 * (j - 1) + i - 1] / (real_type) (shared->nc50_inf[shared->dim_nc50_inf_1 * (j - 1) + i - 1] * shared->nc50_age[k - 1])), shared->ws[i - 1])) : 1);
      }
    }
    for (int i = 1; i <= 4; ++i) {
      for (int j = 2; j <= 3; ++j) {
    ...
    for (int i = 1; i <= 4; ++i) {
      for (int j = 1; j <= 3; ++j) {
        for (int k = 1; k <= shared->N_age; ++k) {
          internal.RR_dis_vc[i - 1 + shared->dim_RR_dis_vc_1 * (j - 1) + shared->dim_RR_dis_vc_12 * (k - 1)] = (shared->ZeroVE == 1 ? 1 : (shared->L_dis[shared->dim_L_dis_1 * (j - 1) + i - 1] / (real_type) (1 + dust::math::pow<real_type>((internal.nc[shared->dim_nc_12 * (k - 1) + shared->dim_nc_1 * (j - 1) + i - 1] / (real_type) (shared->nc50_dis[shared->dim_nc50_dis_1 * (j - 1) + i - 1] * shared->nc50_age[k - 1])), shared->ws[i - 1]))) / (real_type) internal.RR_inf_vc[shared->dim_RR_inf_vc_12 * (k - 1) + shared->dim_RR_inf_vc_1 * (j - 1) + i - 1]);
        }
      }
    }
    for (int i = 1; i <= 4; ++i) {
    ...
    for (int i = 1; i <= 4; ++i) {
      for (int j = 1; j <= 3; ++j) {
        for (int k = 1; k <= shared->N_age; ++k) {
          internal.RR_sdis_vc[i - 1 + shared->dim_RR_sdis_vc_1 * (j - 1) + shared->dim_RR_sdis_vc_12 * (k - 1)] = (shared->ZeroVE == 1 ? 1 : shared->L_sdis[shared->dim_L_sdis_1 * (j - 1) + i - 1] / (real_type) (1 + dust::math::pow<real_type>((internal.nc[shared->dim_nc_12 * (k - 1) + shared->dim_nc_1 * (j - 1) + i - 1] / (real_type) (shared->nc50_sdis[shared->dim_nc50_sdis_1 * (j - 1) + i - 1] * shared->nc50_age[k - 1])), shared->ws[i - 1])) / (real_type) internal.RR_inf_vc[shared->dim_RR_inf_vc_12 * (k - 1) + shared->dim_RR_inf_vc_1 * (j - 1) + i - 1]);
        }
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
    ...
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_dis_sero_unvacc[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.disease_sero[shared->dim_disease_sero_12 * (i - 1) + shared->dim_disease_sero_1 * 0 + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_dis_sero_vacc[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : odin_sum3<real_type>(internal.disease_sero.data(), static_cast<int>(intYPV + shared->vca) - 1, static_cast<int>(intYPV + shared->vca), 1, 3, i - 1, i, shared->dim_disease_sero_1, shared->dim_disease_sero_12));
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_dis_sero_vacc_neg[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.disease_sero[shared->dim_disease_sero_12 * (i - 1) + shared->dim_disease_sero_1 * 2 + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_dis_sero_vacc_pos[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.disease_sero[shared->dim_disease_sero_12 * (i - 1) + shared->dim_disease_sero_1 * 1 + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_dis_sero_vacc_pri[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.disease_sero_vacc_pri[shared->dim_disease_sero_vacc_pri_1 * (i - 1) + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_sdis_sero_unvacc[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.sdisease_sero[shared->dim_sdisease_sero_12 * (i - 1) + shared->dim_sdisease_sero_1 * 0 + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_sdis_sero_vacc[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : odin_sum3<real_type>(internal.sdisease_sero.data(), static_cast<int>(intYPV + shared->vca) - 1, static_cast<int>(intYPV + shared->vca), 1, 3, i - 1, i, shared->dim_sdisease_sero_1, shared->dim_sdisease_sero_12));
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_sdis_sero_vacc_neg[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.sdisease_sero[shared->dim_sdisease_sero_12 * (i - 1) + shared->dim_sdisease_sero_1 * 2 + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_sdis_sero_vacc_pos[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.sdisease_sero[shared->dim_sdisease_sero_12 * (i - 1) + shared->dim_sdisease_sero_1 * 1 + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_sdis_sero_vacc_pri[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.sdisease_sero_vacc_pri[shared->dim_sdisease_sero_vacc_pri_1 * (i - 1) + static_cast<int>(intYPV + shared->vca) - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
    ...
    for (int i = 1; i <= shared->N_age; ++i) {
      for (int j = 1; j <= 3; ++j) {
        internal.disc_yll_all[i - 1 + shared->dim_disc_yll_all_1 * (j - 1)] = odin_sum3<real_type>(internal.sdisease_sero.data(), i - 1, i, j - 1, j, 0, shared->dim_sdisease_sero_3, shared->dim_sdisease_sero_1, shared->dim_sdisease_sero_12) * shared->cfr * (1 - 1 / (real_type) (dust::math::pow<real_type>(shared->disc_fact, internal.life_expec[i - 1]))) / (real_type) dust::math::log(shared->disc_fact);
      }
    }
    for (int i = 1; i <= shared->N_age; ++i) {
      for (int j = 1; j <= 3; ++j) {
    ...
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_dis_sero_vacc_secp[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.cohort_dis_sero_vacc[i - 1] - internal.cohort_dis_sero_vacc_pri[i - 1]);
    }
    for (int i = 1; i <= 4; ++i) {
      internal.cohort_sdis_sero_vacc_secp[i - 1] = ((YEARS_POST_VACC < 0) || ((YEARS_POST_VACC) >= 20) ? 0 : internal.cohort_sdis_sero_vacc[i - 1] - internal.cohort_sdis_sero_vacc_pri[i - 1]);
    }
    ...
    real_type dis_all_vacc_pri = odin_sum1<real_type>(internal.dis_sero_vacc_pri.data(), 0, shared->dim_dis_sero_vacc_pri);
    for (int i = 1; i <= 4; ++i) {
    ...
    real_type sdis_all_vacc_pri = odin_sum1<real_type>(internal.sdis_sero_vacc_pri.data(), 0, shared->dim_sdis_sero_vacc_pri);
    for (int i = 1; i <= 4; ++i) {
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_dis_sero_unvacc + i - 1 + shared->dim_out_cohort_dis_sero_unvacc_1 * (j - 1)] = out_cohort_dis_sero_unvacc[shared->dim_out_cohort_dis_sero_unvacc_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_dis_sero_unvacc[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_dis_sero_vacc + i - 1 + shared->dim_out_cohort_dis_sero_vacc_1 * (j - 1)] = out_cohort_dis_sero_vacc[shared->dim_out_cohort_dis_sero_vacc_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_dis_sero_vacc[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_dis_sero_vacc_neg + i - 1 + shared->dim_out_cohort_dis_sero_vacc_neg_1 * (j - 1)] = out_cohort_dis_sero_vacc_neg[shared->dim_out_cohort_dis_sero_vacc_neg_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_dis_sero_vacc_neg[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_dis_sero_vacc_pos + i - 1 + shared->dim_out_cohort_dis_sero_vacc_pos_1 * (j - 1)] = out_cohort_dis_sero_vacc_pos[shared->dim_out_cohort_dis_sero_vacc_pos_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_dis_sero_vacc_pos[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_dis_sero_vacc_pri + i - 1 + shared->dim_out_cohort_dis_sero_vacc_pri_1 * (j - 1)] = out_cohort_dis_sero_vacc_pri[shared->dim_out_cohort_dis_sero_vacc_pri_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_dis_sero_vacc_pri[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_sdis_sero_unvacc + i - 1 + shared->dim_out_cohort_sdis_sero_unvacc_1 * (j - 1)] = out_cohort_sdis_sero_unvacc[shared->dim_out_cohort_sdis_sero_unvacc_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_sdis_sero_unvacc[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_sdis_sero_vacc + i - 1 + shared->dim_out_cohort_sdis_sero_vacc_1 * (j - 1)] = out_cohort_sdis_sero_vacc[shared->dim_out_cohort_sdis_sero_vacc_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_sdis_sero_vacc[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_sdis_sero_vacc_neg + i - 1 + shared->dim_out_cohort_sdis_sero_vacc_neg_1 * (j - 1)] = out_cohort_sdis_sero_vacc_neg[shared->dim_out_cohort_sdis_sero_vacc_neg_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_sdis_sero_vacc_neg[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_sdis_sero_vacc_pos + i - 1 + shared->dim_out_cohort_sdis_sero_vacc_pos_1 * (j - 1)] = out_cohort_sdis_sero_vacc_pos[shared->dim_out_cohort_sdis_sero_vacc_pos_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_sdis_sero_vacc_pos[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_sdis_sero_vacc_pri + i - 1 + shared->dim_out_cohort_sdis_sero_vacc_pri_1 * (j - 1)] = out_cohort_sdis_sero_vacc_pri[shared->dim_out_cohort_sdis_sero_vacc_pri_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_sdis_sero_vacc_pri[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
    ...
    real_type dis_all_vacc_secp = odin_sum1<real_type>(internal.dis_sero_vacc_secp.data(), 0, shared->dim_dis_sero_vacc_secp);
    ...
    real_type sdis_all_vacc_secp = odin_sum1<real_type>(internal.sdis_sero_vacc_secp.data(), 0, shared->dim_sdis_sero_vacc_secp);
    for (int i = 1; i <= shared->N_age; ++i) {
      int j = 1;
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_dis_sero_vacc_secp + i - 1 + shared->dim_out_cohort_dis_sero_vacc_secp_1 * (j - 1)] = out_cohort_dis_sero_vacc_secp[shared->dim_out_cohort_dis_sero_vacc_secp_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_dis_sero_vacc_secp[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
        state_next[shared->offset_variable_out_cohort_sdis_sero_vacc_secp + i - 1 + shared->dim_out_cohort_sdis_sero_vacc_secp_1 * (j - 1)] = out_cohort_sdis_sero_vacc_secp[shared->dim_out_cohort_sdis_sero_vacc_secp_1 * (j - 1) + i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : internal.cohort_sdis_sero_vacc_secp[j - 1]));
      }
    }
    for (int i = 1; i <= shared->NYO; ++i) {
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_dis_all_vacc_pri + i - 1] = out_dis_all_vacc_pri[i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : dis_all_vacc_pri));
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_sdis_all_vacc_pri + i - 1] = out_sdis_all_vacc_pri[i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : sdis_all_vacc_pri));
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
    ...
    real_type yll_all_vacc_pri = odin_sum1<real_type>(internal.yll_sero_vacc_pri.data(), 0, shared->dim_yll_sero_vacc_pri);
    for (int i = 1; i <= 4; ++i) {
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_dis_all_vacc_secp + i - 1] = out_dis_all_vacc_secp[i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : dis_all_vacc_secp));
    }
    for (int i = 1; i <= shared->NYO; ++i) {
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_sdis_all_vacc_secp + i - 1] = out_sdis_all_vacc_secp[i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : sdis_all_vacc_secp));
    }
    for (int i = 1; i <= shared->NYO; ++i) {
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_yll_all_vacc_pri + i - 1] = out_yll_all_vacc_pri[i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : yll_all_vacc_pri));
    }
    for (int i = 1; i <= shared->NYO; ++i) {
      for (int j = 1; j <= 4; ++j) {
    ...
    real_type yll_all_vacc_secp = odin_sum1<real_type>(internal.yll_sero_vacc_secp.data(), 0, shared->dim_yll_sero_vacc_secp);
    for (int i = 1; i <= shared->N_age; ++i) {
      int j = 1;
    ...
    for (int i = 1; i <= shared->NYO; ++i) {
      state_next[shared->offset_variable_out_yll_all_vacc_secp + i - 1] = out_yll_all_vacc_secp[i - 1] + ((internal.out_update_switch[i - 1] == 0 ? 0 : yll_all_vacc_secp));
    }
  }
private:
...
dust::pars_type<model> dust_pars<model>(cpp11::list user) {
  ...
  shared->dim_cohort_dis_sero_vacc = 4;
  shared->dim_cohort_dis_sero_vacc_neg = 4;
  shared->dim_cohort_dis_sero_vacc_pos = 4;
  shared->dim_cohort_dis_sero_vacc_pri = 4;
  shared->dim_cohort_dis_sero_vacc_secp = 4;
  shared->dim_cohort_sdis_sero_unvacc = 4;
  shared->dim_cohort_sdis_sero_vacc = 4;
  shared->dim_cohort_sdis_sero_vacc_neg = 4;
  shared->dim_cohort_sdis_sero_vacc_pos = 4;
  shared->dim_cohort_sdis_sero_vacc_pri = 4;
  shared->dim_cohort_sdis_sero_vacc_secp = 4;
  ...
  shared->dim_nc50_inf_1 = 4;
  shared->dim_nc50_inf_2 = 3;
  ...
  shared->Wb_relinf4 = 1;
  shared->YEAR_STEP = 1;
  internal.cohort_dis_sero_unvacc = std::vector<real_type>(shared->dim_cohort_dis_sero_unvacc);
  internal.cohort_dis_sero_vacc = std::vector<real_type>(shared->dim_cohort_dis_sero_vacc);
  internal.cohort_dis_sero_vacc_neg = std::vector<real_type>(shared->dim_cohort_dis_sero_vacc_neg);
  internal.cohort_dis_sero_vacc_pos = std::vector<real_type>(shared->dim_cohort_dis_sero_vacc_pos);
  internal.cohort_dis_sero_vacc_pri = std::vector<real_type>(shared->dim_cohort_dis_sero_vacc_pri);
  internal.cohort_dis_sero_vacc_secp = std::vector<real_type>(shared->dim_cohort_dis_sero_vacc_secp);
  internal.cohort_sdis_sero_unvacc = std::vector<real_type>(shared->dim_cohort_sdis_sero_unvacc);
  internal.cohort_sdis_sero_vacc = std::vector<real_type>(shared->dim_cohort_sdis_sero_vacc);
  internal.cohort_sdis_sero_vacc_neg = std::vector<real_type>(shared->dim_cohort_sdis_sero_vacc_neg);
  internal.cohort_sdis_sero_vacc_pos = std::vector<real_type>(shared->dim_cohort_sdis_sero_vacc_pos);
  internal.cohort_sdis_sero_vacc_pri = std::vector<real_type>(shared->dim_cohort_sdis_sero_vacc_pri);
  internal.cohort_sdis_sero_vacc_secp = std::vector<real_type>(shared->dim_cohort_sdis_sero_vacc_secp);
  ...
  shared->dim_nc50_inf = shared->dim_nc50_inf_1 * shared->dim_nc50_inf_2;
  ...
  shared->dim_O_S_2 = 3;
  shared->dim_out_cohort_dis_sero_unvacc_1 = shared->NYO;
  shared->dim_out_cohort_dis_sero_unvacc_2 = 4;
  shared->dim_out_cohort_dis_sero_vacc_1 = shared->NYO;
  shared->dim_out_cohort_dis_sero_vacc_2 = 4;
  shared->dim_out_cohort_dis_sero_vacc_neg_1 = shared->NYO;
  shared->dim_out_cohort_dis_sero_vacc_neg_2 = 4;
  shared->dim_out_cohort_dis_sero_vacc_pos_1 = shared->NYO;
  shared->dim_out_cohort_dis_sero_vacc_pos_2 = 4;
  shared->dim_out_cohort_dis_sero_vacc_pri_1 = shared->NYO;
  shared->dim_out_cohort_dis_sero_vacc_pri_2 = 4;
  shared->dim_out_cohort_dis_sero_vacc_secp_1 = shared->NYO;
  shared->dim_out_cohort_dis_sero_vacc_secp_2 = 4;
  shared->dim_out_cohort_nvacc_neg = shared->NYO;
  shared->dim_out_cohort_nvacc_pos = shared->NYO;
  shared->dim_out_cohort_sdis_sero_unvacc_1 = shared->NYO;
  shared->dim_out_cohort_sdis_sero_unvacc_2 = 4;
  shared->dim_out_cohort_sdis_sero_vacc_1 = shared->NYO;
  shared->dim_out_cohort_sdis_sero_vacc_2 = 4;
  shared->dim_out_cohort_sdis_sero_vacc_neg_1 = shared->NYO;
  shared->dim_out_cohort_sdis_sero_vacc_neg_2 = 4;
  shared->dim_out_cohort_sdis_sero_vacc_pos_1 = shared->NYO;
  shared->dim_out_cohort_sdis_sero_vacc_pos_2 = 4;
  shared->dim_out_cohort_sdis_sero_vacc_pri_1 = shared->NYO;
  shared->dim_out_cohort_sdis_sero_vacc_pri_2 = 4;
  shared->dim_out_cohort_sdis_sero_vacc_secp_1 = shared->NYO;
  shared->dim_out_cohort_sdis_sero_vacc_secp_2 = 4;
  ...
  shared->dim_out_dis_all_vacc_pri = shared->NYO;
  shared->dim_out_dis_all_vacc_secp = shared->NYO;
  ...
  shared->dim_out_sdis_all_vacc_pri = shared->NYO;
  shared->dim_out_sdis_all_vacc_secp = shared->NYO;
  ...
  shared->dim_out_yll_all_vacc_pri = shared->NYO;
  shared->dim_out_yll_all_vacc_secp = shared->NYO;
  ...
  shared->initial_out_cohort_nvacc_neg = std::vector<real_type>(shared->dim_out_cohort_nvacc_neg);
  shared->initial_out_cohort_nvacc_pos = std::vector<real_type>(shared->dim_out_cohort_nvacc_pos);
  ...
  shared->initial_out_dis_all_vacc_pri = std::vector<real_type>(shared->dim_out_dis_all_vacc_pri);
  shared->initial_out_dis_all_vacc_secp = std::vector<real_type>(shared->dim_out_dis_all_vacc_secp);
  ...
  shared->initial_out_sdis_all_vacc_pri = std::vector<real_type>(shared->dim_out_sdis_all_vacc_pri);
  shared->initial_out_sdis_all_vacc_secp = std::vector<real_type>(shared->dim_out_sdis_all_vacc_secp);
  ...
  shared->initial_out_yll_all_vacc_pri = std::vector<real_type>(shared->dim_out_yll_all_vacc_pri);
  shared->initial_out_yll_all_vacc_secp = std::vector<real_type>(shared->dim_out_yll_all_vacc_secp);
  ...
  shared->dim_out_cohort_dis_sero_unvacc = shared->dim_out_cohort_dis_sero_unvacc_1 * shared->dim_out_cohort_dis_sero_unvacc_2;
  shared->dim_out_cohort_dis_sero_vacc = shared->dim_out_cohort_dis_sero_vacc_1 * shared->dim_out_cohort_dis_sero_vacc_2;
  shared->dim_out_cohort_dis_sero_vacc_neg = shared->dim_out_cohort_dis_sero_vacc_neg_1 * shared->dim_out_cohort_dis_sero_vacc_neg_2;
  shared->dim_out_cohort_dis_sero_vacc_pos = shared->dim_out_cohort_dis_sero_vacc_pos_1 * shared->dim_out_cohort_dis_sero_vacc_pos_2;
  shared->dim_out_cohort_dis_sero_vacc_pri = shared->dim_out_cohort_dis_sero_vacc_pri_1 * shared->dim_out_cohort_dis_sero_vacc_pri_2;
  shared->dim_out_cohort_dis_sero_vacc_secp = shared->dim_out_cohort_dis_sero_vacc_secp_1 * shared->dim_out_cohort_dis_sero_vacc_secp_2;
  shared->dim_out_cohort_sdis_sero_unvacc = shared->dim_out_cohort_sdis_sero_unvacc_1 * shared->dim_out_cohort_sdis_sero_unvacc_2;
  shared->dim_out_cohort_sdis_sero_vacc = shared->dim_out_cohort_sdis_sero_vacc_1 * shared->dim_out_cohort_sdis_sero_vacc_2;
  shared->dim_out_cohort_sdis_sero_vacc_neg = shared->dim_out_cohort_sdis_sero_vacc_neg_1 * shared->dim_out_cohort_sdis_sero_vacc_neg_2;
  shared->dim_out_cohort_sdis_sero_vacc_pos = shared->dim_out_cohort_sdis_sero_vacc_pos_1 * shared->dim_out_cohort_sdis_sero_vacc_pos_2;
  shared->dim_out_cohort_sdis_sero_vacc_pri = shared->dim_out_cohort_sdis_sero_vacc_pri_1 * shared->dim_out_cohort_sdis_sero_vacc_pri_2;
  shared->dim_out_cohort_sdis_sero_vacc_secp = shared->dim_out_cohort_sdis_sero_vacc_secp_1 * shared->dim_out_cohort_sdis_sero_vacc_secp_2;
  ...
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_cohort_nvacc_neg[i - 1] = 0;
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_cohort_nvacc_pos[i - 1] = 0;
  }
  for (int i = 1; i <= shared->NYO; ++i) {
  ...
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_dis_all_vacc_pri[i - 1] = 0;
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_dis_all_vacc_secp[i - 1] = 0;
  }
  for (int i = 1; i <= shared->NYO; ++i) {
  ...
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_sdis_all_vacc_pri[i - 1] = 0;
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_sdis_all_vacc_secp[i - 1] = 0;
  }
  for (int i = 1; i <= shared->N_age; ++i) {
  ...
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_yll_all_vacc_pri[i - 1] = 0;
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    shared->initial_out_yll_all_vacc_secp[i - 1] = 0;
  }
  for (int i = 1; i <= shared->NYO; ++i) {
  ...
  shared->offset_variable_out_cohort_nvacc_neg = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_nvacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_out_dis_all_vacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_out_dis_all_vacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_all_vacc_pri = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_all_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_disc_dis_all_pop = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_disc_dis_all_vacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_disc_nvacc_all_pop = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_disc_sdis_all_pop = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_out_sdis_all_vacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_sdis_all_vacc_pri = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_sdis_all_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_out_yll_all_vacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_all_vacc_pri = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_all_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_S = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_VE_seroneg = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_time_from_last_dose + 47;
  shared->offset_variable_VE_seropos_mono = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_time_from_last_dose + shared->dim_VE_seroneg + 47;
  ...
  shared->initial_out_cohort_dis_sero_unvacc = std::vector<real_type>(shared->dim_out_cohort_dis_sero_unvacc);
  shared->initial_out_cohort_dis_sero_vacc = std::vector<real_type>(shared->dim_out_cohort_dis_sero_vacc);
  shared->initial_out_cohort_dis_sero_vacc_neg = std::vector<real_type>(shared->dim_out_cohort_dis_sero_vacc_neg);
  shared->initial_out_cohort_dis_sero_vacc_pos = std::vector<real_type>(shared->dim_out_cohort_dis_sero_vacc_pos);
  shared->initial_out_cohort_dis_sero_vacc_pri = std::vector<real_type>(shared->dim_out_cohort_dis_sero_vacc_pri);
  shared->initial_out_cohort_dis_sero_vacc_secp = std::vector<real_type>(shared->dim_out_cohort_dis_sero_vacc_secp);
  shared->initial_out_cohort_sdis_sero_unvacc = std::vector<real_type>(shared->dim_out_cohort_sdis_sero_unvacc);
  shared->initial_out_cohort_sdis_sero_vacc = std::vector<real_type>(shared->dim_out_cohort_sdis_sero_vacc);
  shared->initial_out_cohort_sdis_sero_vacc_neg = std::vector<real_type>(shared->dim_out_cohort_sdis_sero_vacc_neg);
  shared->initial_out_cohort_sdis_sero_vacc_pos = std::vector<real_type>(shared->dim_out_cohort_sdis_sero_vacc_pos);
  shared->initial_out_cohort_sdis_sero_vacc_pri = std::vector<real_type>(shared->dim_out_cohort_sdis_sero_vacc_pri);
  shared->initial_out_cohort_sdis_sero_vacc_secp = std::vector<real_type>(shared->dim_out_cohort_sdis_sero_vacc_secp);
  ...
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_dis_sero_unvacc[i - 1 + shared->dim_out_cohort_dis_sero_unvacc_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_dis_sero_vacc[i - 1 + shared->dim_out_cohort_dis_sero_vacc_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_dis_sero_vacc_neg[i - 1 + shared->dim_out_cohort_dis_sero_vacc_neg_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_dis_sero_vacc_pos[i - 1 + shared->dim_out_cohort_dis_sero_vacc_pos_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_dis_sero_vacc_pri[i - 1 + shared->dim_out_cohort_dis_sero_vacc_pri_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_dis_sero_vacc_secp[i - 1 + shared->dim_out_cohort_dis_sero_vacc_secp_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_sdis_sero_unvacc[i - 1 + shared->dim_out_cohort_sdis_sero_unvacc_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_sdis_sero_vacc[i - 1 + shared->dim_out_cohort_sdis_sero_vacc_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_sdis_sero_vacc_neg[i - 1 + shared->dim_out_cohort_sdis_sero_vacc_neg_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_sdis_sero_vacc_pos[i - 1 + shared->dim_out_cohort_sdis_sero_vacc_pos_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_sdis_sero_vacc_pri[i - 1 + shared->dim_out_cohort_sdis_sero_vacc_pri_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
      shared->initial_out_cohort_sdis_sero_vacc_secp[i - 1 + shared->dim_out_cohort_sdis_sero_vacc_secp_1 * (j - 1)] = 0;
    }
  }
  for (int i = 1; i <= shared->NYO; ++i) {
    for (int j = 1; j <= 4; ++j) {
  ...
  shared->offset_variable_I1 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I12 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_I21 + shared->dim_I3 + shared->dim_I31 + shared->dim_I4 + shared->dim_I41 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I123 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I132 + shared->dim_I14 + shared->dim_I142 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I24 + shared->dim_I241 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I1234 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_I13 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I2 + shared->dim_I21 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I132 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I14 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I24 + shared->dim_I241 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_I14 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_I2 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I21 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_I3 + shared->dim_I4 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_I231 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I14 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I24 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_I3 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_I4 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_I3 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I41 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_I21 + shared->dim_I3 + shared->dim_I31 + shared->dim_I4 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I42 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I2 + shared->dim_I21 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I4 + shared->dim_I41 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_I43 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_dis_sero_unvacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_dis_sero_vacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_dis_sero_vacc_neg = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_dis_sero_vacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_dis_sero_vacc_pri = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_dis_sero_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_sdis_sero_unvacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_sdis_sero_vacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_sdis_sero_vacc_neg = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_sdis_sero_vacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_sdis_sero_vacc_pri = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_cohort_sdis_sero_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_sero_pop = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_sero_unvacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_sero_vacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_sero_vacc_neg = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_sero_vacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_sero_vacc_pri = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_dis_sero_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_out_sdis_sero_unvacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_sdis_sero_vacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_sdis_sero_vacc_neg = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_out_sdis_sero_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_sero_pop = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_sero_unvacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_out_yll_sero_pop + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_sero_vacc = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_out_yll_sero_pop + shared->dim_out_yll_sero_unvacc + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_sero_vacc_neg = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_out_yll_sero_pop + shared->dim_out_yll_sero_unvacc + shared->dim_out_yll_sero_vacc + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_sero_vacc_pos = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_out_yll_sero_pop + shared->dim_out_yll_sero_unvacc + shared->dim_out_yll_sero_vacc + shared->dim_out_yll_sero_vacc_neg + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_sero_vacc_pri = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_out_yll_sero_pop + shared->dim_out_yll_sero_unvacc + shared->dim_out_yll_sero_vacc + shared->dim_out_yll_sero_vacc_neg + shared->dim_out_yll_sero_vacc_pos + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_out_yll_sero_vacc_secp = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I1234 + shared->dim_I124 + shared->dim_I1243 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I1342 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I2341 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_dis_sero_unvacc + shared->dim_out_cohort_dis_sero_vacc + shared->dim_out_cohort_dis_sero_vacc_neg + shared->dim_out_cohort_dis_sero_vacc_pos + shared->dim_out_cohort_dis_sero_vacc_pri + shared->dim_out_cohort_dis_sero_vacc_secp + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_cohort_sdis_sero_unvacc + shared->dim_out_cohort_sdis_sero_vacc + shared->dim_out_cohort_sdis_sero_vacc_neg + shared->dim_out_cohort_sdis_sero_vacc_pos + shared->dim_out_cohort_sdis_sero_vacc_pri + shared->dim_out_cohort_sdis_sero_vacc_secp + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_dis_sero_pop + shared->dim_out_dis_sero_unvacc + shared->dim_out_dis_sero_vacc + shared->dim_out_dis_sero_vacc_neg + shared->dim_out_dis_sero_vacc_pos + shared->dim_out_dis_sero_vacc_pri + shared->dim_out_dis_sero_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_sdis_sero_pop + shared->dim_out_sdis_sero_unvacc + shared->dim_out_sdis_sero_vacc + shared->dim_out_sdis_sero_vacc_neg + shared->dim_out_sdis_sero_vacc_pos + shared->dim_out_sdis_sero_vacc_pri + shared->dim_out_sdis_sero_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_out_yll_sero_pop + shared->dim_out_yll_sero_unvacc + shared->dim_out_yll_sero_vacc + shared->dim_out_yll_sero_vacc_neg + shared->dim_out_yll_sero_vacc_pos + shared->dim_out_yll_sero_vacc_pri + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R1234 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R234 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  ...
  shared->offset_variable_R124 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I124 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R13 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I14 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I24 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R134 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I124 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R124 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R14 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I14 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I24 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R13 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R2 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_I3 + shared->dim_I4 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R23 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I14 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I24 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R234 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I123 + shared->dim_I124 + shared->dim_I13 + shared->dim_I132 + shared->dim_I134 + shared->dim_I14 + shared->dim_I142 + shared->dim_I143 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I231 + shared->dim_I234 + shared->dim_I24 + shared->dim_I241 + shared->dim_I243 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I341 + shared->dim_I342 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R123 + shared->dim_R124 + shared->dim_R13 + shared->dim_R134 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R24 + shared->dim_R3 + shared->dim_R34 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R24 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I14 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I24 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R3 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_I3 + shared->dim_I4 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R34 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I12 + shared->dim_I13 + shared->dim_I14 + shared->dim_I2 + shared->dim_I21 + shared->dim_I23 + shared->dim_I24 + shared->dim_I3 + shared->dim_I31 + shared->dim_I32 + shared->dim_I34 + shared->dim_I4 + shared->dim_I41 + shared->dim_I42 + shared->dim_I43 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R12 + shared->dim_R13 + shared->dim_R14 + shared->dim_R2 + shared->dim_R23 + shared->dim_R24 + shared->dim_R3 + shared->dim_R4 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  shared->offset_variable_R4 = shared->dim_cum_infection_pri + shared->dim_cum_infection_priV + shared->dim_cum_infection_sec + shared->dim_cum_infection_secV + shared->dim_cum_infection_tq + shared->dim_cum_infection_tqV + shared->dim_I1 + shared->dim_I2 + shared->dim_I3 + shared->dim_I4 + shared->dim_Ntotal_out + shared->dim_out_cohort_nvacc_neg + shared->dim_out_cohort_nvacc_pos + shared->dim_out_dis_all_pop + shared->dim_out_dis_all_unvacc + shared->dim_out_dis_all_vacc + shared->dim_out_dis_all_vacc_neg + shared->dim_out_dis_all_vacc_pos + shared->dim_out_dis_all_vacc_pri + shared->dim_out_dis_all_vacc_secp + shared->dim_out_disc_dis_all_pop + shared->dim_out_disc_dis_all_vacc + shared->dim_out_disc_nvacc_all_pop + shared->dim_out_disc_sdis_all_pop + shared->dim_out_disc_sdis_all_vacc + shared->dim_out_disc_yll_all_pop + shared->dim_out_disc_yll_all_vacc + shared->dim_out_nvacc_all_neg + shared->dim_out_nvacc_all_pop + shared->dim_out_nvacc_all_pos + shared->dim_out_prop_seroneg_at_9 + shared->dim_out_prop_seroneg_at_vca + shared->dim_out_sdis_all_pop + shared->dim_out_sdis_all_unvacc + shared->dim_out_sdis_all_vacc + shared->dim_out_sdis_all_vacc_neg + shared->dim_out_sdis_all_vacc_pos + shared->dim_out_sdis_all_vacc_pri + shared->dim_out_sdis_all_vacc_secp + shared->dim_out_time_from_last_dose + shared->dim_out_yll_all_pop + shared->dim_out_yll_all_unvacc + shared->dim_out_yll_all_vacc + shared->dim_out_yll_all_vacc_neg + shared->dim_out_yll_all_vacc_pos + shared->dim_out_yll_all_vacc_pri + shared->dim_out_yll_all_vacc_secp + shared->dim_R1 + shared->dim_R2 + shared->dim_R3 + shared->dim_S + shared->dim_VE_seroneg + shared->dim_VE_seropos_mono + shared->dim_VE_seropos_multi + 47;
  {
     int i = 1;
     shared->ageb[i - 1] = 0;
  }
  ...
  shared->Kc_mean = shared->Mwt * shared->delta * (dust::math::pow<real_type>((shared->epsilon * (shared->gamma - shared->delta) / (real_type) (shared->delta * shared->sigma) - 1), (- 1 / (real_type) shared->omega))) / (real_type) shared->epsilon;
  ...
  shared->nc50_inf = user_get_array_fixed<real_type, 2>(user, "nc50_inf", shared->nc50_inf, {shared->dim_nc50_inf_1, shared->dim_nc50_inf_2}, NA_REAL, NA_REAL);
...
cpp11::sexp dust_info<model>(const dust::pars_type<model>& pars) {
  ...
  cpp11::writable::strings nms({"Lwt", "Mwt_S", "Mwt_E1", "Mwt_E2", "Mwt_E3", "Mwt_E4", "Mwt_I1", "Mwt_I2", "Mwt_I3", "Mwt_I4", "Lwb", "Mwb_S", "Mwb_E1", "Mwb_E2", "Mwb_E3", "Mwb_E4", "Mwb_I1", "Mwb_I2", "Mwb_I3", "Mwb_I4", "NT_out", "NTv_out", "NTnv_out", "NTvS_out", "NTvE_out", "prop_seroneg_at_9_out", "prop_seroneg_at_vca_out", "Y1T_out", "Y2T_out", "Y3T_out", "Y4T_out", "exposed1", "exposed2", "exposed3", "exposed4", "infectious1", "infectious2", "infectious3", "infectious4", "inc_FOI1", "inc_FOI2", "inc_FOI3", "inc_FOI4", "tot_inc_FOI", "cum_prop_seroneg_at_9", "cum_prop_seroneg_at_vca", "tot_inc_dis", "out_time_from_last_dose", "Ntotal_out", "cum_infection_pri", "cum_infection_priV", "cum_infection_sec", "cum_infection_secV", "cum_infection_tq", "cum_infection_tqV", "VE_seroneg", "VE_seropos_mono", "VE_seropos_multi", "out_prop_seroneg_at_9", "out_prop_seroneg_at_vca", "out_dis_all_pop", "out_dis_all_unvacc", "out_dis_all_vacc", "out_dis_all_vacc_neg", "out_dis_all_vacc_pos", "out_dis_all_vacc_pri", "out_dis_all_vacc_secp", "out_disc_dis_all_pop", "out_disc_dis_all_vacc", "out_cohort_nvacc_neg", "out_cohort_nvacc_pos", "out_sdis_all_pop", "out_sdis_all_unvacc", "out_sdis_all_vacc", "out_sdis_all_vacc_neg", "out_sdis_all_vacc_pos", "out_sdis_all_vacc_pri", "out_sdis_all_vacc_secp", "out_disc_sdis_all_pop", "out_disc_sdis_all_vacc", "out_yll_all_pop", "out_yll_all_unvacc", "out_yll_all_vacc", "out_yll_all_vacc_neg", "out_yll_all_vacc_pos", "out_yll_all_vacc_pri", "out_yll_all_vacc_secp", "out_disc_yll_all_pop", "out_disc_yll_all_vacc", "out_nvacc_all_pop", "out_nvacc_all_neg", "out_nvacc_all_pos", "out_disc_nvacc_all_pop", "S", "I1", "I2", "I3", "I4", "R1", "R2", "R3", "R4", "I21", "I31", "I41", "I12", "I32", "I42", "I13", "I23", "I43", "I14", "I24", "I34", "R12", "R13", "R14", "R23", "R24", "R34", "I231", "I241", "I341", "I132", "I142", "I342", "I123", "I143", "I243", "I124", "I134", "I234", "R123", "R124", "R134", "R234", "I2341", "I1342", "I1243", "I1234", "R1234", "out_dis_sero_pop", "out_dis_sero_unvacc", "out_dis_sero_vacc", "out_dis_sero_vacc_neg", "out_dis_sero_vacc_pos", "out_dis_sero_vacc_pri", "out_dis_sero_vacc_secp", "out_cohort_dis_sero_unvacc", "out_cohort_dis_sero_vacc", "out_cohort_dis_sero_vacc_pri", "out_cohort_dis_sero_vacc_secp", "out_cohort_dis_sero_vacc_neg", "out_cohort_dis_sero_vacc_pos", "out_sdis_sero_pop", "out_sdis_sero_unvacc", "out_sdis_sero_vacc", "out_sdis_sero_vacc_neg", "out_sdis_sero_vacc_pos", "out_sdis_sero_vacc_pri", "out_sdis_sero_vacc_secp", "out_cohort_sdis_sero_unvacc", "out_cohort_sdis_sero_vacc", "out_cohort_sdis_sero_vacc_pri", "out_cohort_sdis_sero_vacc_secp", "out_cohort_sdis_sero_vacc_neg", "out_cohort_sdis_sero_vacc_pos", "out_yll_sero_pop", "out_yll_sero_unvacc", "out_yll_sero_vacc", "out_yll_sero_vacc_neg", "out_yll_sero_vacc_pos", "out_yll_sero_vacc_pri", "out_yll_sero_vacc_secp", "out_nc", "out_RR"});
  cpp11::writable::list dim(176);
  ...
  dim[55] = cpp11::writable::integers({shared->dim_VE_seroneg});
  dim[56] = cpp11::writable::integers({shared->dim_VE_seropos_mono});
  dim[57] = cpp11::writable::integers({shared->dim_VE_seropos_multi});
  dim[58] = cpp11::writable::integers({shared->dim_out_prop_seroneg_at_9});
  dim[59] = cpp11::writable::integers({shared->dim_out_prop_seroneg_at_vca});
  dim[60] = cpp11::writable::integers({shared->dim_out_dis_all_pop});
  dim[61] = cpp11::writable::integers({shared->dim_out_dis_all_unvacc});
  dim[62] = cpp11::writable::integers({shared->dim_out_dis_all_vacc});
  dim[63] = cpp11::writable::integers({shared->dim_out_dis_all_vacc_neg});
  dim[64] = cpp11::writable::integers({shared->dim_out_dis_all_vacc_pos});
  dim[65] = cpp11::writable::integers({shared->dim_out_dis_all_vacc_pri});
  dim[66] = cpp11::writable::integers({shared->dim_out_dis_all_vacc_secp});
  dim[67] = cpp11::writable::integers({shared->dim_out_disc_dis_all_pop});
  dim[68] = cpp11::writable::integers({shared->dim_out_disc_dis_all_vacc});
  dim[69] = cpp11::writable::integers({shared->dim_out_cohort_nvacc_neg});
  dim[70] = cpp11::writable::integers({shared->dim_out_cohort_nvacc_pos});
  dim[71] = cpp11::writable::integers({shared->dim_out_sdis_all_pop});
  dim[72] = cpp11::writable::integers({shared->dim_out_sdis_all_unvacc});
  dim[73] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc});
  dim[74] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_neg});
  dim[75] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_pos});
  dim[76] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_pri});
  dim[77] = cpp11::writable::integers({shared->dim_out_sdis_all_vacc_secp});
  dim[78] = cpp11::writable::integers({shared->dim_out_disc_sdis_all_pop});
  dim[79] = cpp11::writable::integers({shared->dim_out_disc_sdis_all_vacc});
  dim[80] = cpp11::writable::integers({shared->dim_out_yll_all_pop});
  dim[81] = cpp11::writable::integers({shared->dim_out_yll_all_unvacc});
  dim[82] = cpp11::writable::integers({shared->dim_out_yll_all_vacc});
  dim[83] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_neg});
  dim[84] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_pos});
  dim[85] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_pri});
  dim[86] = cpp11::writable::integers({shared->dim_out_yll_all_vacc_secp});
  dim[87] = cpp11::writable::integers({shared->dim_out_disc_yll_all_pop});
  dim[88] = cpp11::writable::integers({shared->dim_out_disc_yll_all_vacc});
  dim[89] = cpp11::writable::integers({shared->dim_out_nvacc_all_pop});
  dim[90] = cpp11::writable::integers({shared->dim_out_nvacc_all_neg});
  dim[91] = cpp11::writable::integers({shared->dim_out_nvacc_all_pos});
  dim[92] = cpp11::writable::integers({shared->dim_out_disc_nvacc_all_pop});
  dim[93] = cpp11::writable::integers({shared->dim_S_1, shared->dim_S_2});
  dim[94] = cpp11::writable::integers({shared->dim_I1_1, shared->dim_I1_2});
  dim[95] = cpp11::writable::integers({shared->dim_I2_1, shared->dim_I2_2});
  dim[96] = cpp11::writable::integers({shared->dim_I3_1, shared->dim_I3_2});
  dim[97] = cpp11::writable::integers({shared->dim_I4_1, shared->dim_I4_2});
  dim[98] = cpp11::writable::integers({shared->dim_R1_1, shared->dim_R1_2});
  dim[99] = cpp11::writable::integers({shared->dim_R2_1, shared->dim_R2_2});
  dim[100] = cpp11::writable::integers({shared->dim_R3_1, shared->dim_R3_2});
  dim[101] = cpp11::writable::integers({shared->dim_R4_1, shared->dim_R4_2});
  dim[102] = cpp11::writable::integers({shared->dim_I21_1, shared->dim_I21_2});
  dim[103] = cpp11::writable::integers({shared->dim_I31_1, shared->dim_I31_2});
  dim[104] = cpp11::writable::integers({shared->dim_I41_1, shared->dim_I41_2});
  dim[105] = cpp11::writable::integers({shared->dim_I12_1, shared->dim_I12_2});
  dim[106] = cpp11::writable::integers({shared->dim_I32_1, shared->dim_I32_2});
  dim[107] = cpp11::writable::integers({shared->dim_I42_1, shared->dim_I42_2});
  dim[108] = cpp11::writable::integers({shared->dim_I13_1, shared->dim_I13_2});
  dim[109] = cpp11::writable::integers({shared->dim_I23_1, shared->dim_I23_2});
  dim[110] = cpp11::writable::integers({shared->dim_I43_1, shared->dim_I43_2});
  dim[111] = cpp11::writable::integers({shared->dim_I14_1, shared->dim_I14_2});
  dim[112] = cpp11::writable::integers({shared->dim_I24_1, shared->dim_I24_2});
  dim[113] = cpp11::writable::integers({shared->dim_I34_1, shared->dim_I34_2});
  dim[114] = cpp11::writable::integers({shared->dim_R12_1, shared->dim_R12_2});
  dim[115] = cpp11::writable::integers({shared->dim_R13_1, shared->dim_R13_2});
  dim[116] = cpp11::writable::integers({shared->dim_R14_1, shared->dim_R14_2});
  dim[117] = cpp11::writable::integers({shared->dim_R23_1, shared->dim_R23_2});
  dim[118] = cpp11::writable::integers({shared->dim_R24_1, shared->dim_R24_2});
  dim[119] = cpp11::writable::integers({shared->dim_R34_1, shared->dim_R34_2});
  dim[120] = cpp11::writable::integers({shared->dim_I231_1, shared->dim_I231_2});
  dim[121] = cpp11::writable::integers({shared->dim_I241_1, shared->dim_I241_2});
  dim[122] = cpp11::writable::integers({shared->dim_I341_1, shared->dim_I341_2});
  dim[123] = cpp11::writable::integers({shared->dim_I132_1, shared->dim_I132_2});
  dim[124] = cpp11::writable::integers({shared->dim_I142_1, shared->dim_I142_2});
  dim[125] = cpp11::writable::integers({shared->dim_I342_1, shared->dim_I342_2});
  dim[126] = cpp11::writable::integers({shared->dim_I123_1, shared->dim_I123_2});
  dim[127] = cpp11::writable::integers({shared->dim_I143_1, shared->dim_I143_2});
  dim[128] = cpp11::writable::integers({shared->dim_I243_1, shared->dim_I243_2});
  dim[129] = cpp11::writable::integers({shared->dim_I124_1, shared->dim_I124_2});
  dim[130] = cpp11::writable::integers({shared->dim_I134_1, shared->dim_I134_2});
  dim[131] = cpp11::writable::integers({shared->dim_I234_1, shared->dim_I234_2});
  dim[132] = cpp11::writable::integers({shared->dim_R123_1, shared->dim_R123_2});
  dim[133] = cpp11::writable::integers({shared->dim_R124_1, shared->dim_R124_2});
  dim[134] = cpp11::writable::integers({shared->dim_R134_1, shared->dim_R134_2});
  dim[135] = cpp11::writable::integers({shared->dim_R234_1, shared->dim_R234_2});
  dim[136] = cpp11::writable::integers({shared->dim_I2341_1, shared->dim_I2341_2});
  dim[137] = cpp11::writable::integers({shared->dim_I1342_1, shared->dim_I1342_2});
  dim[138] = cpp11::writable::integers({shared->dim_I1243_1, shared->dim_I1243_2});
  dim[139] = cpp11::writable::integers({shared->dim_I1234_1, shared->dim_I1234_2});
  dim[140] = cpp11::writable::integers({shared->dim_R1234_1, shared->dim_R1234_2});
  dim[141] = cpp11::writable::integers({shared->dim_out_dis_sero_pop_1, shared->dim_out_dis_sero_pop_2});
  dim[142] = cpp11::writable::integers({shared->dim_out_dis_sero_unvacc_1, shared->dim_out_dis_sero_unvacc_2});
  dim[143] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_1, shared->dim_out_dis_sero_vacc_2});
  dim[144] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_neg_1, shared->dim_out_dis_sero_vacc_neg_2});
  dim[145] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_pos_1, shared->dim_out_dis_sero_vacc_pos_2});
  dim[146] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_pri_1, shared->dim_out_dis_sero_vacc_pri_2});
  dim[147] = cpp11::writable::integers({shared->dim_out_dis_sero_vacc_secp_1, shared->dim_out_dis_sero_vacc_secp_2});
  dim[148] = cpp11::writable::integers({shared->dim_out_cohort_dis_sero_unvacc_1, shared->dim_out_cohort_dis_sero_unvacc_2});
  dim[149] = cpp11::writable::integers({shared->dim_out_cohort_dis_sero_vacc_1, shared->dim_out_cohort_dis_sero_vacc_2});
  dim[150] = cpp11::writable::integers({shared->dim_out_cohort_dis_sero_vacc_pri_1, shared->dim_out_cohort_dis_sero_vacc_pri_2});
  dim[151] = cpp11::writable::integers({shared->dim_out_cohort_dis_sero_vacc_secp_1, shared->dim_out_cohort_dis_sero_vacc_secp_2});
  dim[152] = cpp11::writable::integers({shared->dim_out_cohort_dis_sero_vacc_neg_1, shared->dim_out_cohort_dis_sero_vacc_neg_2});
  dim[153] = cpp11::writable::integers({shared->dim_out_cohort_dis_sero_vacc_pos_1, shared->dim_out_cohort_dis_sero_vacc_pos_2});
  dim[154] = cpp11::writable::integers({shared->dim_out_sdis_sero_pop_1, shared->dim_out_sdis_sero_pop_2});
  dim[155] = cpp11::writable::integers({shared->dim_out_sdis_sero_unvacc_1, shared->dim_out_sdis_sero_unvacc_2});
  dim[156] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_1, shared->dim_out_sdis_sero_vacc_2});
  dim[157] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_neg_1, shared->dim_out_sdis_sero_vacc_neg_2});
  dim[158] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_pos_1, shared->dim_out_sdis_sero_vacc_pos_2});
  dim[159] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_pri_1, shared->dim_out_sdis_sero_vacc_pri_2});
  dim[160] = cpp11::writable::integers({shared->dim_out_sdis_sero_vacc_secp_1, shared->dim_out_sdis_sero_vacc_secp_2});
  dim[161] = cpp11::writable::integers({shared->dim_out_cohort_sdis_sero_unvacc_1, shared->dim_out_cohort_sdis_sero_unvacc_2});
  dim[162] = cpp11::writable::integers({shared->dim_out_cohort_sdis_sero_vacc_1, shared->dim_out_cohort_sdis_sero_vacc_2});
  dim[163] = cpp11::writable::integers({shared->dim_out_cohort_sdis_sero_vacc_pri_1, shared->dim_out_cohort_sdis_sero_vacc_pri_2});
  dim[164] = cpp11::writable::integers({shared->dim_out_cohort_sdis_sero_vacc_secp_1, shared->dim_out_cohort_sdis_sero_vacc_secp_2});
  dim[165] = cpp11::writable::integers({shared->dim_out_cohort_sdis_sero_vacc_neg_1, shared->dim_out_cohort_sdis_sero_vacc_neg_2});
  dim[166] = cpp11::writable::integers({shared->dim_out_cohort_sdis_sero_vacc_pos_1, shared->dim_out_cohort_sdis_sero_vacc_pos_2});
  dim[167] = cpp11::writable::integers({shared->dim_out_yll_sero_pop_1, shared->dim_out_yll_sero_pop_2});
  dim[168] = cpp11::writable::integers({shared->dim_out_yll_sero_unvacc_1, shared->dim_out_yll_sero_unvacc_2});
  dim[169] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_1, shared->dim_out_yll_sero_vacc_2});
  dim[170] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_neg_1, shared->dim_out_yll_sero_vacc_neg_2});
  dim[171] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_pos_1, shared->dim_out_yll_sero_vacc_pos_2});
  dim[172] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_pri_1, shared->dim_out_yll_sero_vacc_pri_2});
  dim[173] = cpp11::writable::integers({shared->dim_out_yll_sero_vacc_secp_1, shared->dim_out_yll_sero_vacc_secp_2});
  dim[174] = cpp11::writable::integers({shared->dim_out_nc_1, shared->dim_out_nc_2, shared->dim_out_nc_3});
  dim[175] = cpp11::writable::integers({shared->dim_out_RR_1, shared->dim_out_RR_2, shared->dim_out_RR_3});
  dim.names() = nms;
  cpp11::writable::list index(176);
  ...
  index[55] = integer_sequence(shared->offset_variable_VE_seroneg + 1, shared->dim_VE_seroneg);
  index[56] = integer_sequence(shared->offset_variable_VE_seropos_mono + 1, shared->dim_VE_seropos_mono);
  index[57] = integer_sequence(shared->offset_variable_VE_seropos_multi + 1, shared->dim_VE_seropos_multi);
  index[58] = integer_sequence(shared->offset_variable_out_prop_seroneg_at_9 + 1, shared->dim_out_prop_seroneg_at_9);
  index[59] = integer_sequence(shared->offset_variable_out_prop_seroneg_at_vca + 1, shared->dim_out_prop_seroneg_at_vca);
  index[60] = integer_sequence(shared->offset_variable_out_dis_all_pop + 1, shared->dim_out_dis_all_pop);
  index[61] = integer_sequence(shared->offset_variable_out_dis_all_unvacc + 1, shared->dim_out_dis_all_unvacc);
  index[62] = integer_sequence(shared->offset_variable_out_dis_all_vacc + 1, shared->dim_out_dis_all_vacc);
  index[63] = integer_sequence(shared->offset_variable_out_dis_all_vacc_neg + 1, shared->dim_out_dis_all_vacc_neg);
  index[64] = integer_sequence(shared->offset_variable_out_dis_all_vacc_pos + 1, shared->dim_out_dis_all_vacc_pos);
  index[65] = integer_sequence(shared->offset_variable_out_dis_all_vacc_pri + 1, shared->dim_out_dis_all_vacc_pri);
  index[66] = integer_sequence(shared->offset_variable_out_dis_all_vacc_secp + 1, shared->dim_out_dis_all_vacc_secp);
  index[67] = integer_sequence(shared->offset_variable_out_disc_dis_all_pop + 1, shared->dim_out_disc_dis_all_pop);
  index[68] = integer_sequence(shared->offset_variable_out_disc_dis_all_vacc + 1, shared->dim_out_disc_dis_all_vacc);
  index[69] = integer_sequence(shared->offset_variable_out_cohort_nvacc_neg + 1, shared->dim_out_cohort_nvacc_neg);
  index[70] = integer_sequence(shared->offset_variable_out_cohort_nvacc_pos + 1, shared->dim_out_cohort_nvacc_pos);
  index[71] = integer_sequence(shared->offset_variable_out_sdis_all_pop + 1, shared->dim_out_sdis_all_pop);
  index[72] = integer_sequence(shared->offset_variable_out_sdis_all_unvacc + 1, shared->dim_out_sdis_all_unvacc);
  index[73] = integer_sequence(shared->offset_variable_out_sdis_all_vacc + 1, shared->dim_out_sdis_all_vacc);
  index[74] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_neg + 1, shared->dim_out_sdis_all_vacc_neg);
  index[75] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_pos + 1, shared->dim_out_sdis_all_vacc_pos);
  index[76] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_pri + 1, shared->dim_out_sdis_all_vacc_pri);
  index[77] = integer_sequence(shared->offset_variable_out_sdis_all_vacc_secp + 1, shared->dim_out_sdis_all_vacc_secp);
  index[78] = integer_sequence(shared->offset_variable_out_disc_sdis_all_pop + 1, shared->dim_out_disc_sdis_all_pop);
  index[79] = integer_sequence(shared->offset_variable_out_disc_sdis_all_vacc + 1, shared->dim_out_disc_sdis_all_vacc);
  index[80] = integer_sequence(shared->offset_variable_out_yll_all_pop + 1, shared->dim_out_yll_all_pop);
  index[81] = integer_sequence(shared->offset_variable_out_yll_all_unvacc + 1, shared->dim_out_yll_all_unvacc);
  index[82] = integer_sequence(shared->offset_variable_out_yll_all_vacc + 1, shared->dim_out_yll_all_vacc);
  index[83] = integer_sequence(shared->offset_variable_out_yll_all_vacc_neg + 1, shared->dim_out_yll_all_vacc_neg);
  index[84] = integer_sequence(shared->offset_variable_out_yll_all_vacc_pos + 1, shared->dim_out_yll_all_vacc_pos);
  index[85] = integer_sequence(shared->offset_variable_out_yll_all_vacc_pri + 1, shared->dim_out_yll_all_vacc_pri);
  index[86] = integer_sequence(shared->offset_variable_out_yll_all_vacc_secp + 1, shared->dim_out_yll_all_vacc_secp);
  index[87] = integer_sequence(shared->offset_variable_out_disc_yll_all_pop + 1, shared->dim_out_disc_yll_all_pop);
  index[88] = integer_sequence(shared->offset_variable_out_disc_yll_all_vacc + 1, shared->dim_out_disc_yll_all_vacc);
  index[89] = integer_sequence(shared->offset_variable_out_nvacc_all_pop + 1, shared->dim_out_nvacc_all_pop);
  index[90] = integer_sequence(shared->offset_variable_out_nvacc_all_neg + 1, shared->dim_out_nvacc_all_neg);
  index[91] = integer_sequence(shared->offset_variable_out_nvacc_all_pos + 1, shared->dim_out_nvacc_all_pos);
  index[92] = integer_sequence(shared->offset_variable_out_disc_nvacc_all_pop + 1, shared->dim_out_disc_nvacc_all_pop);
  index[93] = integer_sequence(shared->offset_variable_S + 1, shared->dim_S);
  index[94] = integer_sequence(shared->offset_variable_I1 + 1, shared->dim_I1);
  index[95] = integer_sequence(shared->offset_variable_I2 + 1, shared->dim_I2);
  index[96] = integer_sequence(shared->offset_variable_I3 + 1, shared->dim_I3);
  index[97] = integer_sequence(shared->offset_variable_I4 + 1, shared->dim_I4);
  index[98] = integer_sequence(shared->offset_variable_R1 + 1, shared->dim_R1);
  index[99] = integer_sequence(shared->offset_variable_R2 + 1, shared->dim_R2);
  index[100] = integer_sequence(shared->offset_variable_R3 + 1, shared->dim_R3);
  index[101] = integer_sequence(shared->offset_variable_R4 + 1, shared->dim_R4);
  index[102] = integer_sequence(shared->offset_variable_I21 + 1, shared->dim_I21);
  index[103] = integer_sequence(shared->offset_variable_I31 + 1, shared->dim_I31);
  index[104] = integer_sequence(shared->offset_variable_I41 + 1, shared->dim_I41);
  index[105] = integer_sequence(shared->offset_variable_I12 + 1, shared->dim_I12);
  index[106] = integer_sequence(shared->offset_variable_I32 + 1, shared->dim_I32);
  index[107] = integer_sequence(shared->offset_variable_I42 + 1, shared->dim_I42);
  index[108] = integer_sequence(shared->offset_variable_I13 + 1, shared->dim_I13);
  index[109] = integer_sequence(shared->offset_variable_I23 + 1, shared->dim_I23);
  index[110] = integer_sequence(shared->offset_variable_I43 + 1, shared->dim_I43);
  index[111] = integer_sequence(shared->offset_variable_I14 + 1, shared->dim_I14);
  index[112] = integer_sequence(shared->offset_variable_I24 + 1, shared->dim_I24);
  index[113] = integer_sequence(shared->offset_variable_I34 + 1, shared->dim_I34);
  index[114] = integer_sequence(shared->offset_variable_R12 + 1, shared->dim_R12);
  index[115] = integer_sequence(shared->offset_variable_R13 + 1, shared->dim_R13);
  index[116] = integer_sequence(shared->offset_variable_R14 + 1, shared->dim_R14);
  index[117] = integer_sequence(shared->offset_variable_R23 + 1, shared->dim_R23);
  index[118] = integer_sequence(shared->offset_variable_R24 + 1, shared->dim_R24);
  index[119] = integer_sequence(shared->offset_variable_R34 + 1, shared->dim_R34);
  index[120] = integer_sequence(shared->offset_variable_I231 + 1, shared->dim_I231);
  index[121] = integer_sequence(shared->offset_variable_I241 + 1, shared->dim_I241);
  index[122] = integer_sequence(shared->offset_variable_I341 + 1, shared->dim_I341);
  index[123] = integer_sequence(shared->offset_variable_I132 + 1, shared->dim_I132);
  index[124] = integer_sequence(shared->offset_variable_I142 + 1, shared->dim_I142);
  index[125] = integer_sequence(shared->offset_variable_I342 + 1, shared->dim_I342);
  index[126] = integer_sequence(shared->offset_variable_I123 + 1, shared->dim_I123);
  index[127] = integer_sequence(shared->offset_variable_I143 + 1, shared->dim_I143);
  index[128] = integer_sequence(shared->offset_variable_I243 + 1, shared->dim_I243);
  index[129] = integer_sequence(shared->offset_variable_I124 + 1, shared->dim_I124);
  index[130] = integer_sequence(shared->offset_variable_I134 + 1, shared->dim_I134);
  index[131] = integer_sequence(shared->offset_variable_I234 + 1, shared->dim_I234);
  index[132] = integer_sequence(shared->offset_variable_R123 + 1, shared->dim_R123);
  index[133] = integer_sequence(shared->offset_variable_R124 + 1, shared->dim_R124);
  index[134] = integer_sequence(shared->offset_variable_R134 + 1, shared->dim_R134);
  index[135] = integer_sequence(shared->offset_variable_R234 + 1, shared->dim_R234);
  index[136] = integer_sequence(shared->offset_variable_I2341 + 1, shared->dim_I2341);
  index[137] = integer_sequence(shared->offset_variable_I1342 + 1, shared->dim_I1342);
  index[138] = integer_sequence(shared->offset_variable_I1243 + 1, shared->dim_I1243);
  index[139] = integer_sequence(shared->offset_variable_I1234 + 1, shared->dim_I1234);
  index[140] = integer_sequence(shared->offset_variable_R1234 + 1, shared->dim_R1234);
  index[141] = integer_sequence(shared->offset_variable_out_dis_sero_pop + 1, shared->dim_out_dis_sero_pop);
  index[142] = integer_sequence(shared->offset_variable_out_dis_sero_unvacc + 1, shared->dim_out_dis_sero_unvacc);
  index[143] = integer_sequence(shared->offset_variable_out_dis_sero_vacc + 1, shared->dim_out_dis_sero_vacc);
  index[144] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_neg + 1, shared->dim_out_dis_sero_vacc_neg);
  index[145] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_pos + 1, shared->dim_out_dis_sero_vacc_pos);
  index[146] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_pri + 1, shared->dim_out_dis_sero_vacc_pri);
  index[147] = integer_sequence(shared->offset_variable_out_dis_sero_vacc_secp + 1, shared->dim_out_dis_sero_vacc_secp);
  index[148] = integer_sequence(shared->offset_variable_out_cohort_dis_sero_unvacc + 1, shared->dim_out_cohort_dis_sero_unvacc);
  index[149] = integer_sequence(shared->offset_variable_out_cohort_dis_sero_vacc + 1, shared->dim_out_cohort_dis_sero_vacc);
  index[150] = integer_sequence(shared->offset_variable_out_cohort_dis_sero_vacc_pri + 1, shared->dim_out_cohort_dis_sero_vacc_pri);
  index[151] = integer_sequence(shared->offset_variable_out_cohort_dis_sero_vacc_secp + 1, shared->dim_out_cohort_dis_sero_vacc_secp);
  index[152] = integer_sequence(shared->offset_variable_out_cohort_dis_sero_vacc_neg + 1, shared->dim_out_cohort_dis_sero_vacc_neg);
  index[153] = integer_sequence(shared->offset_variable_out_cohort_dis_sero_vacc_pos + 1, shared->dim_out_cohort_dis_sero_vacc_pos);
  index[154] = integer_sequence(shared->offset_variable_out_sdis_sero_pop + 1, shared->dim_out_sdis_sero_pop);
  index[155] = integer_sequence(shared->offset_variable_out_sdis_sero_unvacc + 1, shared->dim_out_sdis_sero_unvacc);
  index[156] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc + 1, shared->dim_out_sdis_sero_vacc);
  index[157] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_neg + 1, shared->dim_out_sdis_sero_vacc_neg);
  index[158] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_pos + 1, shared->dim_out_sdis_sero_vacc_pos);
  index[159] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_pri + 1, shared->dim_out_sdis_sero_vacc_pri);
  index[160] = integer_sequence(shared->offset_variable_out_sdis_sero_vacc_secp + 1, shared->dim_out_sdis_sero_vacc_secp);
  index[161] = integer_sequence(shared->offset_variable_out_cohort_sdis_sero_unvacc + 1, shared->dim_out_cohort_sdis_sero_unvacc);
  index[162] = integer_sequence(shared->offset_variable_out_cohort_sdis_sero_vacc + 1, shared->dim_out_cohort_sdis_sero_vacc);
  index[163] = integer_sequence(shared->offset_variable_out_cohort_sdis_sero_vacc_pri + 1, shared->dim_out_cohort_sdis_sero_vacc_pri);
  index[164] = integer_sequence(shared->offset_variable_out_cohort_sdis_sero_vacc_secp + 1, shared->dim_out_cohort_sdis_sero_vacc_secp);
  index[165] = integer_sequence(shared->offset_variable_out_cohort_sdis_sero_vacc_neg + 1, shared->dim_out_cohort_sdis_sero_vacc_neg);
  index[166] = integer_sequence(shared->offset_variable_out_cohort_sdis_sero_vacc_pos + 1, shared->dim_out_cohort_sdis_sero_vacc_pos);
  index[167] = integer_sequence(shared->offset_variable_out_yll_sero_pop + 1, shared->dim_out_yll_sero_pop);
  index[168] = integer_sequence(shared->offset_variable_out_yll_sero_unvacc + 1, shared->dim_out_yll_sero_unvacc);
  index[169] = integer_sequence(shared->offset_variable_out_yll_sero_vacc + 1, shared->dim_out_yll_sero_vacc);
  index[170] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_neg + 1, shared->dim_out_yll_sero_vacc_neg);
  index[171] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_pos + 1, shared->dim_out_yll_sero_vacc_pos);
  index[172] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_pri + 1, shared->dim_out_yll_sero_vacc_pri);
  index[173] = integer_sequence(shared->offset_variable_out_yll_sero_vacc_secp + 1, shared->dim_out_yll_sero_vacc_secp);
  index[174] = integer_sequence(shared->offset_variable_out_nc + 1, shared->dim_out_nc);
  index[175] = integer_sequence(shared->offset_variable_out_RR + 1, shared->dim_out_RR);
  index.names() = nms;
